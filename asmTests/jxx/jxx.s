...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$4923, %rdi             ## imm = 0x133B
	movb	$0, _m+4148(%rip)
	movslq	_m+4919(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+4919(%rip)
	movq	%rax, %r8
	movslq	_m+4919(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_13:
	...
	movl	%ecx, %edx
	movl	21311(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
	movb	(%rax,%rdx), %sil
	movb	%sil, -213(%rbp)        ## 1-byte Spill
	callq	_is_little_endian
	leaq	_m(%rip), %rdx
	movl	$3, %ecx
	xorl	%edi, %edi
...
LBB0_26:
	...
	cmovnel	%esi, %edx
	movslq	%edx, %r8
	movw	-242(%rbp), %r9w        ## 2-byte Reload
	movw	%r9w, 4108(%rcx,%r8)
	callq	_is_little_endian
	leaq	_m(%rip), %rcx
	movl	$2, %edx
...
## BB#39:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+4919(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+4919(%rip)
...
LBB2_44:
	...
	movl	_m+21307(%rip), %eax
	movl	%eax, _m+4100(%rip)
	movzwl	-1020(%rbp), %eax
	addl	_m+21307(%rip), %eax
	movl	%eax, _m+21307(%rip)
...
LBB2_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21307(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280131, 21311(%rax,%rdx,4) ## imm = 0x414F43
	movl	_m+21307(%rip), %ecx
	movl	%ecx, _m+4100(%rip)
	movl	_m+4100(%rip), %esi
	movb	$0, %al
...
LBB2_51:
	...
	movzwl	-1018(%rbp), %edx
	movl	%edx, %r8d
	movl	%esi, 21311(%rcx,%r8,4)
	movzwl	-1018(%rbp), %esi
	movzwl	-1018(%rbp), %edx
	movl	%edx, %r8d
	movl	21311(%rcx,%r8,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB2_55:
	...
	movl	_m+21823(%rip), %eax
	movl	%eax, %ecx
	addq	$21827, %rcx            ## imm = 0x5543
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21823(%rip), %eax
	movl	%eax, _m+21823(%rip)
	movl	_m+21823(%rip), %eax
	movl	%eax, %ecx
	addq	$21827, %rcx            ## imm = 0x5543
	movl	%ecx, %eax
...
Ltmp11:
	...
	leaq	_m(%rip), %rdx
	addq	$4280131, %rdx          ## imm = 0x414F43
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.22(%rip), %rdi
	movzbl	_m+4280131(%rip), %esi
