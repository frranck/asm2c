...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$5044, %rdi             ## imm = 0x13B4
	movb	$0, _m+4269(%rip)
	movslq	_m+5040(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5040(%rip)
	movq	%rax, %r8
	movslq	_m+5040(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_4:
	movl	$2, _m+4221(%rip)
	movl	_m+4221(%rip), %eax
	andl	_m+4221(%rip), %eax
	cmpl	$0, %eax
	sete	%cl
	andb	$1, %cl
	movb	%cl, _m+4266(%rip)
	movl	_m+4221(%rip), %eax
	cmpl	_m+4221(%rip), %eax
	setb	%cl
	andb	$1, %cl
	movb	%cl, _m+4265(%rip)
	movl	_m+4221(%rip), %eax
...
## BB#9:
	jmp	LBB0_17
LBB0_10:
	movl	$-65025, _m+4225(%rip)  ## imm = 0xFFFFFFFFFFFF01FF
	callq	_is_little_endian
	leaq	_m(%rip), %rcx
	movl	$2, %edx
	movl	$1, %esi
...
## BB#20:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+5040(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+5040(%rip)
...
LBB2_10:
	jmp	LBB2_61
LBB2_11:
	movl	$512, _m+4233(%rip)     ## imm = 0x200
	jmp	LBB2_61
LBB2_12:
	cmpq	$0, _m+4408252(%rip)
	je	LBB2_14
## BB#13:
	xorl	%esi, %esi
	...
	leaq	_m(%rip), %rdi
	leaq	-1008(%rbp), %r8
	movq	_m+4408252(%rip), %r9
	movl	_m+4233(%rip), %eax
	movl	%eax, %r10d
	movq	%rdi, %r11
	addq	%r10, %r11
	movzwl	_m+4255(%rip), %eax
	movl	%eax, %r10d
	movl	21432(%rdi,%r10,4), %eax
	movl	%eax, %edi
	addq	%rdi, %r11
	movq	%r8, %rdi
	movq	%r9, %r8
...
LBB2_44:
	...
	movl	_m+21428(%rip), %eax
	movl	%eax, _m+4221(%rip)
	movzwl	-1020(%rbp), %eax
	addl	_m+21428(%rip), %eax
	movl	%eax, _m+21428(%rip)
	movl	_m+4221(%rip), %esi
	movb	$0, %al
	callq	_printf
...
LBB2_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21428(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280252, 21432(%rax,%rdx,4) ## imm = 0x414FBC
	movl	_m+21428(%rip), %ecx
	movl	%ecx, _m+4221(%rip)
	movl	_m+4221(%rip), %esi
	movb	$0, %al
	...
	movl	_m+21428(%rip), %ecx
	addl	$1, %ecx
	movl	%ecx, _m+21428(%rip)
	movl	%eax, -1264(%rbp)       ## 4-byte Spill
	jmp	LBB2_61
LBB2_49:
	leaq	L_.str.58(%rip), %rdi
	movl	_m+4225(%rip), %esi
	movl	_m+4233(%rip), %edx
	movl	_m+4229(%rip), %ecx
	movb	$0, %al
	callq	_printf
	movzwl	-1018(%rbp), %ecx
	cmpl	_m+21428(%rip), %ecx
...
LBB2_51:
	...
	cmovnel	%esi, %edx
	movslq	%edx, %r8
	movzwl	4229(%rcx,%r8), %edx
	shll	$16, %edx
	movl	-1276(%rbp), %esi       ## 4-byte Reload
	addl	%edx, %esi
	movzwl	-1018(%rbp), %edx
	movl	%edx, %r8d
	movl	%esi, 21432(%rcx,%r8,4)
	movzwl	-1018(%rbp), %esi
	movzwl	-1018(%rbp), %edx
	movl	%edx, %r8d
	movl	21432(%rcx,%r8,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB2_55:
	...
	movl	_m+21944(%rip), %eax
	movl	%eax, %ecx
	addq	$21948, %rcx            ## imm = 0x55BC
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21944(%rip), %eax
	movl	%eax, _m+21944(%rip)
	movl	_m+21944(%rip), %eax
	movl	%eax, %ecx
	addq	$21948, %rcx            ## imm = 0x55BC
	movl	%ecx, %eax
...
Ltmp11:
	...
	movzwl	_m+4253(%rip), %ecx
	movl	%ecx, %r8d
	movl	21432(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	leaq	_m(%rip), %rdx
	addq	$4280252, %rdx          ## imm = 0x414FBC
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.22(%rip), %rdi
	movzbl	_m+4280252(%rip), %esi
	movl	%eax, -88(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.23(%rip), %rdi
	movb	_m+4266(%rip), %r10b
	andb	$1, %r10b
	movzbl	%r10b, %esi
