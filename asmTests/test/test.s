...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$5045, %rdi             ## imm = 0x13B5
	movb	$0, _m+4270(%rip)
	movslq	_m+5041(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5041(%rip)
	movq	%rax, %r8
	movslq	_m+5041(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_6:
	...
	movl	$3, %ecx
	xorl	%edx, %edx
	movb	_m+4269(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %edi
	cmovnel	%edx, %edi
	movslq	%edi, %r8
	movzbl	4221(%rax,%r8), %edi
	andl	$0, %edi
	cmpl	$0, %edi
	sete	%sil
	andb	$1, %sil
	movb	%sil, _m+4266(%rip)
	movb	_m+4269(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %edi
	cmovnel	%edx, %edi
	...
	setl	%sil
	andb	$1, %sil
	movb	%sil, _m+4265(%rip)
	movb	_m+4269(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r8
	movzbl	4221(%rax,%r8), %ecx
	andl	$0, %ecx
	sarl	$7, %ecx
	cmpl	$0, %ecx
	setne	%sil
	andb	$1, %sil
	movb	%sil, _m+4268(%rip)
	testb	$1, _m+4266(%rip)
	jne	LBB0_8
## BB#7:
	jmp	LBB0_17
LBB0_8:
	...
	xorl	%edx, %edx
	movl	$2, %esi
	movb	_m+4269(%rip), %dil
	testb	$1, %dil
	movl	%ecx, %r8d
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzbl	4221(%rax,%r9), %r8d
	andl	$2, %r8d
	cmpl	$0, %r8d
	sete	%dil
	andb	$1, %dil
	movb	%dil, _m+4266(%rip)
	movb	_m+4269(%rip), %dil
	testb	$1, %dil
	movl	%ecx, %r8d
	cmovnel	%edx, %r8d
	...
	setl	%dil
	andb	$1, %dil
	movb	%dil, _m+4265(%rip)
	movb	_m+4269(%rip), %dil
	testb	$1, %dil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movzbl	4221(%rax,%r9), %ecx
	andl	$2, %ecx
	sarl	$7, %ecx
	cmpl	$0, %ecx
	setne	%dil
	andb	$1, %dil
	movb	%dil, _m+4268(%rip)
	testb	$1, _m+4266(%rip)
	je	LBB0_10
## BB#9:
	jmp	LBB0_17
...
## BB#20:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+5041(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+5041(%rip)
...
LBB1_44:
	...
	movl	_m+21429(%rip), %eax
	movl	%eax, _m+4221(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+21429(%rip), %eax
	movl	%eax, _m+21429(%rip)
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21429(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280253, 21433(%rax,%rdx,4) ## imm = 0x414FBD
	movl	_m+21429(%rip), %ecx
	movl	%ecx, _m+4221(%rip)
	movl	_m+4221(%rip), %esi
	movb	$0, %al
...
LBB1_51:
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzwl	4233(%rax,%r9), %r8d
	andl	$65535, %r8d            ## imm = 0xFFFF
	movb	_m+4269(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movzwl	4229(%rax,%r9), %ecx
	shll	$16, %ecx
	addl	%ecx, %r8d
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	%r8d, 21433(%rax,%r9,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	21433(%rax,%r9,4), %edx
	movb	$0, %al
	callq	_printf
