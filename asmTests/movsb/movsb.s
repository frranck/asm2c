...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$5062, %rdi             ## imm = 0x13C6
	movb	$0, _m+4287(%rip)
	movslq	_m+5058(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5058(%rip)
	movq	%rax, %r8
	movslq	_m+5058(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_4:
	leaq	_m(%rip), %rax
	addq	$5062, %rax             ## imm = 0x13C6
	movslq	_m+5058(%rip), %rcx
	shlq	$2, %rcx
	addq	%rcx, %rax
	...
	cmovnel	%r8d, %r8d
	movslq	%r8d, %rdx
	movslq	_m+5058(%rip), %rsi
	movw	5062(%rcx,%rsi,4), %r11w
	movw	%r11w, 4275(%rcx,%rdx)
## BB#5:
	leaq	_m(%rip), %rax
	movl	$129, _m+4255(%rip)
	movl	_m+4255(%rip), %ecx
	movl	%ecx, _m+4259(%rip)
	movl	_m+4259(%rip), %ecx
	addl	$1, %ecx
	movl	%ecx, _m+4259(%rip)
	cmpl	$0, _m+4259(%rip)
	sete	%dl
	...
	movq	%rax, %rdi
	addq	%rsi, %rdi
	movzwl	_m+4273(%rip), %ecx
	movl	%ecx, %esi
	movl	21450(%rax,%rsi,4), %ecx
	movl	%ecx, %esi
	addq	%rsi, %rdi
	movq	%rdi, -176(%rbp)
	movl	_m+4259(%rip), %ecx
...
## BB#8:                                ##   in Loop: Header=BB0_7 Depth=1
	...
	movq	$-1, %rcx
	leaq	_m(%rip), %rsi
	movl	_m+4255(%rip), %eax
	movl	%eax, %edi
	movq	%rsi, %r8
	addq	%rdi, %r8
	movzwl	_m+4273(%rip), %eax
	movl	%eax, %edi
	movl	21450(%rsi,%rdi,4), %eax
	movl	%eax, %edi
	addq	%rdi, %r8
	movq	%r8, -176(%rbp)
	movl	_m+4259(%rip), %eax
	movl	%eax, %edi
	movq	%rsi, %r8
	addq	%rdi, %r8
	movzwl	_m+4275(%rip), %eax
	movl	%eax, %edi
	movl	21450(%rsi,%rdi,4), %eax
	movl	%eax, %esi
	addq	%rsi, %r8
	...
	movl	_m+4259(%rip), %r9d
	addl	$1, %r9d
	movl	%r9d, _m+4259(%rip)
	movl	_m+4255(%rip), %r9d
	addl	$1, %r9d
	movl	%r9d, _m+4255(%rip)
...
LBB0_11:
	...
	movq	-168(%rbp), %rdi
	movq	-176(%rbp), %rsi
	movl	_m+4247(%rip), %eax
	shll	$0, %eax
	movl	%eax, %eax
	movl	%eax, %edx
	callq	___memmove_chk
	movl	_m+4247(%rip), %r8d
	shll	$0, %r8d
	addl	_m+4259(%rip), %r8d
	movl	%r8d, _m+4259(%rip)
	movl	_m+4247(%rip), %r8d
	shll	$0, %r8d
	addl	_m+4255(%rip), %r8d
	movl	%r8d, _m+4255(%rip)
	movq	%rax, -240(%rbp)        ## 8-byte Spill
LBB0_12:
	leaq	_m(%rip), %rax
	movl	$129, _m+4259(%rip)
	movzwl	_m+4273(%rip), %ecx
	movl	%ecx, %edx
	movl	21450(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
	movzbl	130(%rax,%rdx), %ecx
	subl	$1, %ecx
	cmpl	$0, %ecx
	sete	%sil
	andb	$1, %sil
	movb	%sil, _m+4284(%rip)
	movzwl	_m+4273(%rip), %ecx
	movl	%ecx, %edx
	movl	21450(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
...
LBB2_10:
	jmp	LBB2_61
LBB2_11:
	movl	$512, _m+4251(%rip)     ## imm = 0x200
	jmp	LBB2_61
LBB2_12:
	cmpq	$0, _m+4408270(%rip)
	je	LBB2_14
## BB#13:
	xorl	%esi, %esi
	...
	leaq	_m(%rip), %rdi
	leaq	-1008(%rbp), %r8
	movq	_m+4408270(%rip), %r9
	movl	_m+4251(%rip), %eax
	movl	%eax, %r10d
	movq	%rdi, %r11
	addq	%r10, %r11
	movzwl	_m+4273(%rip), %eax
	movl	%eax, %r10d
	movl	21450(%rdi,%r10,4), %eax
	movl	%eax, %edi
	addq	%rdi, %r11
	movq	%r8, %rdi
	movq	%r9, %r8
...
LBB2_22:
	...
	addq	%rax, %rsi
	movq	%rsi, -1048(%rbp)
	movl	_m+4247(%rip), %esi
	movzwl	-1020(%rbp), %edx
	movzwl	_m+4273(%rip), %ecx
	movl	_m+4251(%rip), %r8d
	movq	-1048(%rbp), %r9
	movq	_asm2C_INT.file(%rip), %rax
	movq	%rax, (%rsp)
	movb	$0, %al
...
LBB2_44:
	...
	movl	_m+21446(%rip), %eax
	movl	%eax, _m+4239(%rip)
	movzwl	-1020(%rbp), %eax
	addl	_m+21446(%rip), %eax
	movl	%eax, _m+21446(%rip)
	movl	_m+4239(%rip), %esi
	movb	$0, %al
	callq	_printf
...
LBB2_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21446(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280270, 21450(%rax,%rdx,4) ## imm = 0x414FCE
	movl	_m+21446(%rip), %ecx
	movl	%ecx, _m+4239(%rip)
	movl	_m+4239(%rip), %esi
	movb	$0, %al
	...
	movl	_m+21446(%rip), %ecx
	addl	$1, %ecx
	movl	%ecx, _m+21446(%rip)
	movl	%eax, -1264(%rbp)       ## 4-byte Spill
	jmp	LBB2_61
LBB2_49:
	leaq	L_.str.58(%rip), %rdi
	movl	_m+4243(%rip), %esi
	movl	_m+4251(%rip), %edx
	movl	_m+4247(%rip), %ecx
	movb	$0, %al
	callq	_printf
	movzwl	-1018(%rbp), %ecx
	cmpl	_m+21446(%rip), %ecx
...
LBB2_51:
	...
	cmovnel	%esi, %edx
	movslq	%edx, %r8
	movzwl	4247(%rcx,%r8), %edx
	shll	$16, %edx
	movl	-1276(%rbp), %esi       ## 4-byte Reload
	addl	%edx, %esi
	movzwl	-1018(%rbp), %edx
	movl	%edx, %r8d
	movl	%esi, 21450(%rcx,%r8,4)
	movzwl	-1018(%rbp), %esi
	movzwl	-1018(%rbp), %edx
	movl	%edx, %r8d
	movl	21450(%rcx,%r8,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB2_55:
	...
	movl	_m+21962(%rip), %eax
	movl	%eax, %ecx
	addq	$21966, %rcx            ## imm = 0x55CE
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21962(%rip), %eax
	movl	%eax, _m+21962(%rip)
	movl	_m+21962(%rip), %eax
	movl	%eax, %ecx
	addq	$21966, %rcx            ## imm = 0x55CE
	movl	%ecx, %eax
	...
	movl	%esi, _m+4247(%rip)
	movl	-1080(%rbp), %esi
	shrl	$16, %esi
	movl	%esi, _m+4243(%rip)
	movl	$0, _m+4259(%rip)
	movl	$0, _m+4255(%rip)
	movl	-1080(%rbp), %esi
	movl	_m+4243(%rip), %edx
	movl	_m+4247(%rip), %ecx
...
Ltmp11:
	...
	movl	_m+4251(%rip), %esi
	movl	%eax, -36(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.10(%rip), %rdi
	movl	_m+4263(%rip), %esi
	movl	%eax, -40(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.11(%rip), %rdi
	leaq	_m(%rip), %rdx
	movzwl	_m+4271(%rip), %esi
	movzwl	_m+4271(%rip), %ecx
	movl	%ecx, %r8d
	movl	21450(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	callq	_printf
	leaq	_m(%rip), %rdx
	addq	$4275, %rdx             ## imm = 0x10B3
	movl	$4, %esi
	movq	%rdx, %rdi
	movl	%eax, -64(%rbp)         ## 4-byte Spill
	callq	_hexDump
	leaq	L_.str.16(%rip), %rdi
	movl	_m+4259(%rip), %esi
	movb	$0, %al
	callq	_printf
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4277(%rip), %esi
	movzwl	_m+4277(%rip), %eax
	movl	%eax, %r8d
	movl	21450(%rdx,%r8,4), %eax
	movl	%eax, %r8d
	addq	%r8, %rdx
	movb	$0, %al
	callq	_printf
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4279(%rip), %esi
	movzwl	_m+4279(%rip), %ecx
	movl	%ecx, %r8d
	movl	21450(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	leaq	_m(%rip), %rdx
	addq	$4280270, %rdx          ## imm = 0x414FCE
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.22(%rip), %rdi
	movzbl	_m+4280270(%rip), %esi
	movl	%eax, -88(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.23(%rip), %rdi
	movb	_m+4284(%rip), %r10b
	andb	$1, %r10b
	movzbl	%r10b, %esi
