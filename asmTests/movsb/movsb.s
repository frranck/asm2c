...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$5579, %rdi             ## imm = 0x15CB
	movb	$0, _m+49(%rip)
	movl	_m+5575(%rip), %ecx
	movl	%ecx, %r8d
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5575(%rip)
	movq	%rax, %r8
	movl	_m+5575(%rip), %ecx
	movl	%ecx, %r9d
	shlq	$2, %r9
...
LBB0_4:
	...
	movl	$2, %edx
                                        ## 
	movq	$-1, %rsi
	addq	$5579, %rax             ## imm = 0x15CB
	movl	_m+5575(%rip), %edi
	movl	%edi, %r8d
	shlq	$2, %r8
	addq	%r8, %rax
	movq	%rax, %rdi
	...
	callq	___memcpy_chk
	movl	_m+5575(%rip), %r9d
	movl	%r9d, %ecx
	addq	$2, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+5575(%rip)
	movl	_m+5575(%rip), %r9d
	movl	%r9d, %ecx
...
LBB0_15:
	...
	movzwl	_m+34(%rip), %ecx
	movl	%ecx, %edx
	movl	5063(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
	movzbl	182(%rax,%rdx), %ecx
	subl	$1, %ecx
	cmpl	$0, %ecx
	sete	%sil
	andb	$1, %sil
...
LBB1_44:
	...
	movl	_m+5059(%rip), %eax
	movl	%eax, _m(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+5059(%rip), %eax
	movl	%eax, _m+5059(%rip)
	movl	_m(%rip), %esi
	movb	$0, %al
	callq	_log_debug2
## BB#45:
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+5059(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280271, 5063(%rax,%rdx,4) ## imm = 0x414FCF
	movl	_m+5059(%rip), %ecx
	movl	%ecx, _m(%rip)
	movl	_m(%rip), %esi
	movb	$0, %al
...
LBB1_51:
	...
	movzwl	-1022(%rbp), %edx
	movl	%edx, %esi
	movl	%ecx, 5063(%rax,%rsi,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r8d
	movl	5063(%rax,%r8,4), %edx
	movb	$0, %al
	callq	_log_debug2
	jmp	LBB1_61
LBB1_52:
