...
R(JNE(failure));
R(CMP(32,m.esi,32,(((dd)(offsetof(struct Mem,var1)+1)))));
R(JNE(failure));
R(CMP(32,m.edi,32,(((dd)(offsetof(struct Mem,var4)+1)))));
R(JNE(failure));
R(MOV(32,m.esi,32,(((dd)offsetof(struct Mem,var3)))));
R(MOV(32,m.edi,32,(((dd)offsetof(struct Mem,var4)))));
...
R(JNE(failure));
R(CMP(32,m.esi,32,(((dd)(offsetof(struct Mem,var3)+4)))));
R(JNE(failure));
R(CMP(32,m.edi,32,(((dd)(offsetof(struct Mem,var4)+4)))));
R(JNE(failure));
fintest:
R(MOV(32,m.esi,32,(((dd)offsetof(struct Mem,testoverlap)))));
R(MOV(32,READDD(edi),32,(dd)READDD(esi)));
R(INC(32,(READDD(edi))));
R(MOV(32,READDD(ecx),32,(dd)10));
R(REP_MOVSB);
R(LEA(32,m.edi,32,(((dd)offsetof(struct Mem,testoverlap)))));
...
R(MOV(32,READDD(ecx),32,(dd)10));
R(REP_MOVSB);
R(LEA(32,m.edi,32,(((dd)offsetof(struct Mem,var1)))));
