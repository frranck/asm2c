...
R(LEA(32,m.edi,32,(((dd)offsetof(struct Mem,buffer)))));
R(MOV(32,READDD(ebx),32,(dd)5));
CALL(load_raw);
R(XOR(32,READDD(eax),32,(dd)READDD(eax)));
R(CMP(32,*((dd *) realAddress(offsetof(struct Mem,buffer), ds)),32,(dd)(is_little_endian()?1953719636:1415934836)));
R(JNE(failure));
R(JMP(exitlabel));
//PROC load_raw
load_raw:
...
R(PUSH(16,(READDW(es))));
R(PUSH(16,(READDW(ds))));
R(LEA(32,m.edx,32,(((dd)offsetof(struct Mem,filename)))));
R(XOR(32,READDD(eax),32,(dd)READDD(eax)));
