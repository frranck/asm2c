...
LBB0_31:
	...
	movl	%edx, %esi
	movl	68933(%rax,%rsi,4), %edx
	movl	%edx, %esi
	movl	%ecx, 52(%rax,%rsi)
	movzwl	_m+34(%rip), %ecx
	movl	%ecx, %esi
	movl	68933(%rax,%rsi,4), %ecx
	movl	%ecx, %esi
	movl	52(%rax,%rsi), %ecx
	movl	%ecx, _m+4(%rip)
	movb	$66, _m+1(%rip)
...
LBB0_38:
	...
	movl	%esi, %edi
	movq	$-1, %r8
	addq	$69449, %rcx            ## imm = 0x10F49
	movl	$10, _m+8(%rip)
	movzwl	_m+34(%rip), %esi
	movl	%esi, %r9d
	movl	68933(%rax,%r9,4), %esi
	movl	%esi, %r9d
	movl	52(%rax,%r9), %esi
	movl	%esi, _m+4(%rip)
	movb	$63, _m+1(%rip)
...
LBB1_44:
	...
	movl	_m+68929(%rip), %eax
	movl	%eax, _m(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+68929(%rip), %eax
	movl	%eax, _m+68929(%rip)
	movl	_m(%rip), %esi
	movb	$0, %al
	callq	_log_debug2
## BB#45:
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+68929(%rip), %ecx
	movl	%ecx, %edx
	movl	$4344141, 68933(%rax,%rdx,4) ## imm = 0x42494D
	movl	_m+68929(%rip), %ecx
	movl	%ecx, _m(%rip)
	movl	_m(%rip), %esi
	movb	$0, %al
...
LBB1_51:
	...
	movzwl	-1022(%rbp), %edx
	movl	%edx, %esi
	movl	%ecx, 68933(%rax,%rsi,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r8d
	movl	68933(%rax,%r8,4), %edx
	movb	$0, %al
	callq	_log_debug2
	jmp	LBB1_61
LBB1_52:
