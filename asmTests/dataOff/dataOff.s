...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$4945, %rdi             ## imm = 0x1351
	movb	$0, _m+4170(%rip)
	movslq	_m+4941(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+4941(%rip)
	movq	%rax, %r8
	movslq	_m+4941(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_4:
	...
	xorl	%edx, %edx
	movl	$0, _m+4141(%rip)
	movl	_m+4141(%rip), %esi
	movl	%esi, %edi
	movq	%rax, %r8
	addq	%rdi, %r8
	movzwl	_m+4155(%rip), %esi
	movl	%esi, %edi
	movl	21333(%rax,%rdi,4), %esi
	movl	%esi, %edi
	movb	(%r8,%rdi), %r9b
	movb	_m+4169(%rip), %r10b
	testb	$1, %r10b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	movslq	%esi, %rdi
	movb	%r9b, 4133(%rax,%rdi)
	movb	_m+4169(%rip), %r9b
	testb	$1, %r9b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	movslq	%esi, %rdi
	movzbl	4133(%rax,%rdi), %esi
	subl	$2, %esi
	cmpl	$0, %esi
	sete	%r9b
	andb	$1, %r9b
	movb	%r9b, _m+4166(%rip)
	movb	_m+4169(%rip), %r9b
	testb	$1, %r9b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	...
	setl	%r9b
	andb	$1, %r9b
	movb	%r9b, _m+4165(%rip)
	movb	_m+4169(%rip), %r9b
	testb	$1, %r9b
	cmovnel	%edx, %ecx
	movslq	%ecx, %rdi
	movzbl	4133(%rax,%rdi), %ecx
	subl	$2, %ecx
	sarl	$7, %ecx
	cmpl	$0, %ecx
	setne	%r9b
	andb	$1, %r9b
	movb	%r9b, _m+4168(%rip)
	testb	$1, _m+4166(%rip)
	jne	LBB0_6
## BB#5:
	jmp	LBB0_17
LBB0_6:
	...
	cmovnel	%edx, %edi
	movslq	%edi, %r8
	movb	4129(%rax,%r8), %sil
	movl	_m+4141(%rip), %edi
	movl	%edi, %r8d
	movq	%rax, %r9
	addq	%r8, %r9
	movzwl	_m+4155(%rip), %edi
	movl	%edi, %r8d
	movl	21333(%rax,%r8,4), %edi
	movl	%edi, %r8d
	movb	%sil, (%r9,%r8)
	movl	_m+4141(%rip), %edi
	movl	%edi, %r8d
	...
	cmovnel	%edx, %edi
	movslq	%edi, %r8
	movb	%sil, 4133(%rax,%r8)
	movb	_m+4169(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %edi
	cmovnel	%edx, %edi
	movslq	%edi, %r8
	movzbl	4133(%rax,%r8), %edi
	subl	$2, %edi
	cmpl	$0, %edi
	sete	%sil
	andb	$1, %sil
	movb	%sil, _m+4166(%rip)
	movb	_m+4169(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %edi
	cmovnel	%edx, %edi
	...
	setl	%sil
	andb	$1, %sil
	movb	%sil, _m+4165(%rip)
	movb	_m+4169(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r8
	movzbl	4133(%rax,%r8), %ecx
	subl	$2, %ecx
	sarl	$7, %ecx
	cmpl	$0, %ecx
	setne	%sil
	andb	$1, %sil
	movb	%sil, _m+4168(%rip)
	testb	$1, _m+4166(%rip)
	jne	LBB0_8
## BB#7:
	jmp	LBB0_17
...
LBB0_10:
	leaq	_m(%rip), %rax
	movl	_m+4141(%rip), %ecx
	addl	$1, %ecx
	movl	%ecx, %ecx
	movl	%ecx, %edx
	movq	%rax, %rsi
	addq	%rdx, %rsi
	movzwl	_m+4155(%rip), %ecx
	movl	%ecx, %edx
	movl	21333(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
	movzbl	(%rsi,%rdx), %ecx
	addl	$1, %ecx
	movb	%cl, %dil
...
LBB0_14:
	movl	$3, _m+4137(%rip)
	movl	_m+4141(%rip), %eax
	subl	_m+4137(%rip), %eax
	cmpl	$0, %eax
	sete	%cl
	andb	$1, %cl
	movb	%cl, _m+4166(%rip)
	movl	_m+4141(%rip), %eax
	cmpl	_m+4137(%rip), %eax
	setb	%cl
	andb	$1, %cl
	movb	%cl, _m+4165(%rip)
	movl	_m+4141(%rip), %eax
...
## BB#20:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+4941(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+4941(%rip)
...
LBB1_10:
	jmp	LBB1_61
LBB1_11:
	movl	$512, _m+4133(%rip)     ## imm = 0x200
	jmp	LBB1_61
LBB1_12:
	cmpq	$0, _m+4408153(%rip)
	je	LBB1_14
## BB#13:
	xorl	%esi, %esi
	...
	leaq	_m(%rip), %rdi
	leaq	-1008(%rbp), %r8
	movq	_m+4408153(%rip), %r9
	movl	_m+4133(%rip), %eax
	movl	%eax, %r10d
	movq	%rdi, %r11
	addq	%r10, %r11
	movzwl	_m+4155(%rip), %eax
	movl	%eax, %r10d
	movl	21333(%rdi,%r10,4), %eax
	movl	%eax, %edi
	addq	%rdi, %r11
	movq	%r8, %rdi
	movq	%r9, %r8
...
LBB1_22:
	...
	addq	%rax, %rsi
	movq	%rsi, -1048(%rbp)
	movl	_m+4129(%rip), %esi
	movzwl	-1024(%rbp), %edx
	movzwl	_m+4155(%rip), %ecx
	movl	_m+4133(%rip), %r8d
	movq	-1048(%rbp), %r9
	movq	_asm2C_INT.file(%rip), %rax
	movq	%rax, (%rsp)
	movb	$0, %al
...
LBB1_44:
	...
	movl	_m+21329(%rip), %eax
	movl	%eax, _m+4121(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+21329(%rip), %eax
	movl	%eax, _m+21329(%rip)
	movl	_m+4121(%rip), %esi
	movb	$0, %al
	callq	_printf
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21329(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280153, 21333(%rax,%rdx,4) ## imm = 0x414F59
	movl	_m+21329(%rip), %ecx
	movl	%ecx, _m+4121(%rip)
	movl	_m+4121(%rip), %esi
	movb	$0, %al
	...
	movl	_m+21329(%rip), %ecx
	addl	$1, %ecx
	movl	%ecx, _m+21329(%rip)
	movl	%eax, -1256(%rbp)       ## 4-byte Spill
	jmp	LBB1_61
LBB1_49:
	leaq	L_.str.63(%rip), %rdi
	movl	_m+4125(%rip), %esi
	movl	_m+4133(%rip), %edx
	movl	_m+4129(%rip), %ecx
	movb	$0, %al
	callq	_printf
	movzwl	-1022(%rbp), %ecx
	cmpl	_m+21329(%rip), %ecx
...
LBB1_51:
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzwl	4133(%rax,%r9), %r8d
	andl	$65535, %r8d            ## imm = 0xFFFF
	movb	_m+4169(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movzwl	4129(%rax,%r9), %ecx
	shll	$16, %ecx
	addl	%ecx, %r8d
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	%r8d, 21333(%rax,%r9,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	21333(%rax,%r9,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB1_55:
	...
	movl	_m+21845(%rip), %eax
	movl	%eax, %ecx
	addq	$21849, %rcx            ## imm = 0x5559
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21845(%rip), %eax
	movl	%eax, _m+21845(%rip)
	movl	_m+21845(%rip), %eax
	movl	%eax, %ecx
	addq	$21849, %rcx            ## imm = 0x5559
	movl	%ecx, %eax
	...
	movl	%esi, _m+4129(%rip)
	movl	-1080(%rbp), %esi
	shrl	$16, %esi
	movl	%esi, _m+4125(%rip)
	movl	$0, _m+4141(%rip)
	movl	$0, _m+4137(%rip)
	movl	-1080(%rbp), %esi
	movl	_m+4125(%rip), %edx
	movl	_m+4129(%rip), %ecx
...
Ltmp11:
	...
	movl	_m+4133(%rip), %esi
	movl	%eax, -36(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.13(%rip), %rdi
	movl	_m+4145(%rip), %esi
	movl	%eax, -40(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.14(%rip), %rdi
	leaq	_m(%rip), %rdx
	movzwl	_m+4153(%rip), %esi
	movzwl	_m+4153(%rip), %ecx
	movl	%ecx, %r8d
	movl	21333(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	movl	_m+4137(%rip), %esi
	movl	%eax, -52(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.17(%rip), %rdi
	leaq	_m(%rip), %rdx
	movl	_m+4137(%rip), %ecx
	movl	%ecx, %r8d
	movq	%rdx, %r9
	addq	%r8, %r9
	movzwl	_m+4155(%rip), %ecx
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4157(%rip), %esi
	movzwl	_m+4157(%rip), %ecx
	movl	%ecx, %r8d
	movl	21333(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4159(%rip), %esi
	movzwl	_m+4159(%rip), %eax
	movl	%eax, %r8d
	movl	21333(%rdx,%r8,4), %eax
	movl	%eax, %r8d
	addq	%r8, %rdx
	movb	$0, %al
	callq	_printf
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4161(%rip), %esi
	movzwl	_m+4161(%rip), %ecx
	movl	%ecx, %r8d
	movl	21333(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	leaq	_m(%rip), %rdx
	addq	$4280153, %rdx          ## imm = 0x414F59
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.25(%rip), %rdi
	movzbl	_m+4280153(%rip), %esi
	movl	%eax, -88(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.26(%rip), %rdi
	movb	_m+4166(%rip), %r10b
	andb	$1, %r10b
	movzbl	%r10b, %esi
