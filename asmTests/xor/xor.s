...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$4920, %rdi             ## imm = 0x1338
	movb	$0, _m+4145(%rip)
	movslq	_m+4916(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+4916(%rip)
	movq	%rax, %r8
	movslq	_m+4916(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_4:
	movl	$2, _m+4096(%rip)
	movl	_m+4096(%rip), %eax
	xorl	_m+4096(%rip), %eax
...
## BB#5:
	jmp	LBB0_23
LBB0_6:
	movl	$511, _m+4096(%rip)     ## imm = 0x1FF
	movl	$255, _m+4100(%rip)
	movl	_m+4096(%rip), %eax
...
LBB0_8:
	...
	movl	$511, _m+4096(%rip)     ## imm = 0x1FF
	movl	$255, _m+4100(%rip)
	movb	_m+4144(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %edi
	cmovnel	%edx, %edi
	movslq	%edi, %r8
	movzwl	4096(%rax,%r8), %edi
	movb	_m+4144(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %r9d
	cmovnel	%edx, %r9d
	...
	sete	%sil
	andb	$1, %sil
	movb	%sil, _m+4141(%rip)
	movb	_m+4144(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r8
	movzwl	4096(%rax,%r8), %ecx
	sarl	$15, %ecx
	cmpl	$0, %ecx
	setne	%sil
	andb	$1, %sil
	movb	%sil, _m+4143(%rip)
	testb	$1, _m+4141(%rip)
	je	LBB0_10
## BB#9:
	jmp	LBB0_23
LBB0_10:
	...
	cmovnel	%edx, %edi
	movslq	%edi, %r8
	movzbl	4096(%rax,%r8), %edi
	movb	_m+4144(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %r9d
	cmovnel	%edx, %r9d
	movslq	%r9d, %r8
	movzbl	4100(%rax,%r8), %r9d
	xorl	%r9d, %edi
	movb	%dil, %sil
	movb	_m+4144(%rip), %r10b
	testb	$1, %r10b
	movl	%ecx, %edi
	cmovnel	%edx, %edi
	movslq	%edi, %r8
	movb	%sil, 4096(%rax,%r8)
	movb	_m+4144(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %edi
	cmovnel	%edx, %edi
...
LBB0_12:
	...
	andb	$1, %cl
	movb	%cl, _m+4141(%rip)
	cmpl	$256, _m+4096(%rip)     ## imm = 0x100
	setb	%cl
	andb	$1, %cl
	movb	%cl, _m+4140(%rip)
	movl	_m+4096(%rip), %eax
...
LBB0_14:
	...
	movl	$2, %ecx
	movl	$1, %edx
	movl	$61695, _m+4104(%rip)   ## imm = 0xF0FF
	movl	$4095, _m+4100(%rip)    ## imm = 0xFFF
	movb	_m+4144(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %edi
	cmovnel	%edx, %edi
	...
	andb	$1, %sil
	movb	%sil, _m+4141(%rip)
	cmpl	$65535, _m+4104(%rip)   ## imm = 0xFFFF
	setb	%sil
	andb	$1, %sil
	movb	%sil, _m+4140(%rip)
	movl	_m+4104(%rip), %ecx
	subl	$65535, %ecx            ## imm = 0xFFFF
	shrl	$31, %ecx
	cmpl	$0, %ecx
...
LBB0_16:
	...
	movl	$3, %ecx
	xorl	%edx, %edx
	movl	$57089, _m+4104(%rip)   ## imm = 0xDF01
	movb	_m+4144(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %edi
	cmovnel	%edx, %edi
	...
	movb	%sil, _m+4143(%rip)
	movl	_m+4104(%rip), %ecx
	subl	$57329, %ecx            ## imm = 0xDFF1
	cmpl	$0, %ecx
	sete	%sil
	andb	$1, %sil
	movb	%sil, _m+4141(%rip)
	cmpl	$57329, _m+4104(%rip)   ## imm = 0xDFF1
	setb	%sil
	andb	$1, %sil
	movb	%sil, _m+4140(%rip)
	movl	_m+4104(%rip), %ecx
...
## BB#26:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+4916(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+4916(%rip)
...
LBB1_44:
	...
	movl	_m+21304(%rip), %eax
	movl	%eax, _m+4096(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+21304(%rip), %eax
	movl	%eax, _m+21304(%rip)
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21304(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280128, 21308(%rax,%rdx,4) ## imm = 0x414F40
	movl	_m+21304(%rip), %ecx
	movl	%ecx, _m+4096(%rip)
	movl	_m+4096(%rip), %esi
	movb	$0, %al
...
LBB1_51:
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzwl	4108(%rax,%r9), %r8d
	andl	$65535, %r8d            ## imm = 0xFFFF
	movb	_m+4144(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movzwl	4104(%rax,%r9), %ecx
	shll	$16, %ecx
	addl	%ecx, %r8d
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	%r8d, 21308(%rax,%r9,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	21308(%rax,%r9,4), %edx
	movb	$0, %al
	callq	_printf
