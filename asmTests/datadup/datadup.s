...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$5038, %rdi             ## imm = 0x13AE
	movb	$0, _m+4263(%rip)
	movslq	_m+5034(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5034(%rip)
	movq	%rax, %r8
	movslq	_m+5034(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
## BB#22:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+5034(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+5034(%rip)
...
LBB2_44:
	...
	movl	_m+21422(%rip), %eax
	movl	%eax, _m+4215(%rip)
	movzwl	-1020(%rbp), %eax
	addl	_m+21422(%rip), %eax
	movl	%eax, _m+21422(%rip)
...
LBB2_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21422(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280246, 21426(%rax,%rdx,4) ## imm = 0x414FB6
	movl	_m+21422(%rip), %ecx
	movl	%ecx, _m+4215(%rip)
	movl	_m+4215(%rip), %esi
	movb	$0, %al
...
LBB2_51:
	...
	cmovnel	%esi, %edx
	movslq	%edx, %r8
	movzwl	4223(%rcx,%r8), %edx
	shll	$16, %edx
	movl	-1276(%rbp), %esi       ## 4-byte Reload
	addl	%edx, %esi
	movzwl	-1018(%rbp), %edx
	movl	%edx, %r8d
	movl	%esi, 21426(%rcx,%r8,4)
	movzwl	-1018(%rbp), %esi
	movzwl	-1018(%rbp), %edx
	movl	%edx, %r8d
	movl	21426(%rcx,%r8,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB2_55:
	...
	movl	_m+21938(%rip), %eax
	movl	%eax, %ecx
	addq	$21942, %rcx            ## imm = 0x55B6
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21938(%rip), %eax
	movl	%eax, _m+21938(%rip)
	movl	_m+21938(%rip), %eax
	movl	%eax, %ecx
	addq	$21942, %rcx            ## imm = 0x55B6
	movl	%ecx, %eax
...
Ltmp11:
	...
	leaq	_m(%rip), %rdx
	addq	$4280246, %rdx          ## imm = 0x414FB6
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.22(%rip), %rdi
	movzbl	_m+4280246(%rip), %esi
