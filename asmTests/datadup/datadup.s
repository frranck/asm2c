...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$5039, %rdi             ## imm = 0x13AF
	movb	$0, _m+4264(%rip)
	movslq	_m+5035(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5035(%rip)
	movq	%rax, %r8
	movslq	_m+5035(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_4:
	leaq	_m(%rip), %rax
	movzwl	_m+4249(%rip), %ecx
	movl	%ecx, %edx
	movl	21427(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
	movzbl	10(%rax,%rdx), %ecx
	subl	$5, %ecx
	cmpl	$0, %ecx
	sete	%sil
	andb	$1, %sil
	movb	%sil, _m+4260(%rip)
	movzwl	_m+4249(%rip), %ecx
	movl	%ecx, %edx
	movl	21427(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
...
## BB#22:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+5035(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+5035(%rip)
...
LBB1_10:
	jmp	LBB1_61
LBB1_11:
	movl	$512, _m+4227(%rip)     ## imm = 0x200
	jmp	LBB1_61
LBB1_12:
	cmpq	$0, _m+4408247(%rip)
	je	LBB1_14
## BB#13:
	xorl	%esi, %esi
	...
	leaq	_m(%rip), %rdi
	leaq	-1008(%rbp), %r8
	movq	_m+4408247(%rip), %r9
	movl	_m+4227(%rip), %eax
	movl	%eax, %r10d
	movq	%rdi, %r11
	addq	%r10, %r11
	movzwl	_m+4249(%rip), %eax
	movl	%eax, %r10d
	movl	21427(%rdi,%r10,4), %eax
	movl	%eax, %edi
	addq	%rdi, %r11
	movq	%r8, %rdi
	movq	%r9, %r8
...
LBB1_22:
	...
	addq	%rax, %rsi
	movq	%rsi, -1048(%rbp)
	movl	_m+4223(%rip), %esi
	movzwl	-1024(%rbp), %edx
	movzwl	_m+4249(%rip), %ecx
	movl	_m+4227(%rip), %r8d
	movq	-1048(%rbp), %r9
	movq	_asm2C_INT.file(%rip), %rax
	movq	%rax, (%rsp)
	movb	$0, %al
...
LBB1_44:
	...
	movl	_m+21423(%rip), %eax
	movl	%eax, _m+4215(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+21423(%rip), %eax
	movl	%eax, _m+21423(%rip)
	movl	_m+4215(%rip), %esi
	movb	$0, %al
	callq	_printf
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21423(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280247, 21427(%rax,%rdx,4) ## imm = 0x414FB7
	movl	_m+21423(%rip), %ecx
	movl	%ecx, _m+4215(%rip)
	movl	_m+4215(%rip), %esi
	movb	$0, %al
	...
	movl	_m+21423(%rip), %ecx
	addl	$1, %ecx
	movl	%ecx, _m+21423(%rip)
	movl	%eax, -1256(%rbp)       ## 4-byte Spill
	jmp	LBB1_61
LBB1_49:
	leaq	L_.str.63(%rip), %rdi
	movl	_m+4219(%rip), %esi
	movl	_m+4227(%rip), %edx
	movl	_m+4223(%rip), %ecx
	movb	$0, %al
	callq	_printf
	movzwl	-1022(%rbp), %ecx
	cmpl	_m+21423(%rip), %ecx
...
LBB1_51:
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzwl	4227(%rax,%r9), %r8d
	andl	$65535, %r8d            ## imm = 0xFFFF
	movb	_m+4263(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movzwl	4223(%rax,%r9), %ecx
	shll	$16, %ecx
	addl	%ecx, %r8d
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	%r8d, 21427(%rax,%r9,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	21427(%rax,%r9,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB1_55:
	...
	movl	_m+21939(%rip), %eax
	movl	%eax, %ecx
	addq	$21943, %rcx            ## imm = 0x55B7
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21939(%rip), %eax
	movl	%eax, _m+21939(%rip)
	movl	_m+21939(%rip), %eax
	movl	%eax, %ecx
	addq	$21943, %rcx            ## imm = 0x55B7
	movl	%ecx, %eax
	...
	movl	%esi, _m+4223(%rip)
	movl	-1080(%rbp), %esi
	shrl	$16, %esi
	movl	%esi, _m+4219(%rip)
	movl	$0, _m+4235(%rip)
	movl	$0, _m+4231(%rip)
	movl	-1080(%rbp), %esi
	movl	_m+4219(%rip), %edx
	movl	_m+4223(%rip), %ecx
...
Ltmp11:
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4247(%rip), %esi
	movzwl	_m+4247(%rip), %ecx
	movl	%ecx, %r8d
	movl	21427(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	movl	_m+4231(%rip), %esi
	movl	%eax, -52(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.17(%rip), %rdi
	leaq	_m(%rip), %rdx
	movl	_m+4231(%rip), %ecx
	movl	%ecx, %r8d
	movq	%rdx, %r9
	addq	%r8, %r9
	movzwl	_m+4249(%rip), %ecx
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4251(%rip), %esi
	movzwl	_m+4251(%rip), %ecx
	movl	%ecx, %r8d
	movl	21427(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	callq	_printf
	leaq	_m(%rip), %rdx
	addq	$4251, %rdx             ## imm = 0x109B
	movl	$4, %esi
	movq	%rdx, %rdi
	movl	%eax, -64(%rbp)         ## 4-byte Spill
	callq	_hexDump
	leaq	L_.str.19(%rip), %rdi
	movl	_m+4235(%rip), %esi
	movb	$0, %al
	callq	_printf
	leaq	L_.str.20(%rip), %rdi
	leaq	_m(%rip), %rdx
	movl	_m+4235(%rip), %ecx
	movl	%ecx, %r8d
	movq	%rdx, %r9
	addq	%r8, %r9
	movzwl	_m+4251(%rip), %ecx
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4253(%rip), %esi
	movzwl	_m+4253(%rip), %eax
	movl	%eax, %r8d
	movl	21427(%rdx,%r8,4), %eax
	movl	%eax, %r8d
	addq	%r8, %rdx
	movb	$0, %al
	callq	_printf
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4255(%rip), %esi
	movzwl	_m+4255(%rip), %ecx
	movl	%ecx, %r8d
	movl	21427(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	leaq	_m(%rip), %rdx
	addq	$4280247, %rdx          ## imm = 0x414FB7
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.25(%rip), %rdi
	movzbl	_m+4280247(%rip), %esi
	movl	%eax, -88(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.26(%rip), %rdi
	movb	_m+4260(%rip), %r10b
	andb	$1, %r10b
	movzbl	%r10b, %esi
