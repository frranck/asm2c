...
LBB0_18:
	...
	subq	$32, %r8
	movl	%r8d, %edi
	movl	%edi, _m+5432(%rip)
	movl	_m+5432(%rip), %edi
	movl	%edi, %r8d
	movq	5436(%rax,%r8,4), %r9
	movq	%r9, _m(%rip)
	movq	5444(%rax,%r8,4), %r9
	movq	%r9, _m+8(%rip)
	movq	5452(%rax,%r8,4), %r9
	movq	%r9, _m+16(%rip)
	movq	5460(%rax,%r8,4), %r8
	movq	%r8, _m+24(%rip)
	movl	_m+5432(%rip), %edi
	movl	%edi, %r8d
	shlq	$2, %r8
