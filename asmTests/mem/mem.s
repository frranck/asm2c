...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$5106, %rdi             ## imm = 0x13F2
	movb	$0, _m+4331(%rip)
	movslq	_m+5102(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5102(%rip)
	movq	%rax, %r8
	movslq	_m+5102(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_4:
	...
	movb	_m+4330(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %r8d
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movw	4282(%rax,%r9), %r10w
	movb	_m+4330(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %r8d
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movw	%r10w, 4290(%rax,%r9)
	movl	_m+4282(%rip), %r8d
	shrl	$16, %r8d
	movl	%r8d, _m+4282(%rip)
	movb	_m+4330(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %r8d
	cmovnel	%edx, %r8d
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movw	%r10w, 4286(%rax,%r9)
	movb	_m+4330(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movw	$1281, 4282(%rax,%r9)   ## imm = 0x501
	callq	_asm2C_INT
	testb	$1, _m+4331(%rip)
	je	LBB0_8
## BB#5:
...
## BB#6:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+5102(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+5102(%rip)
...
LBB0_11:
	...
	leaq	_m(%rip), %rsi
	movq	%rsi, %rdi
	addq	$4286, %rdi             ## imm = 0x10BE
	movl	$2, %eax
	xorl	%r8d, %r8d
	addq	$5106, %rsi             ## imm = 0x13F2
	movslq	_m+5102(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rsi
	movb	_m+4330(%rip), %r10b
	testb	$1, %r10b
	cmovnel	%r8d, %eax
	movslq	%eax, %r9
	addq	%r9, %rdi
	...
	cmovnel	%r11d, %ebx
	movslq	%ebx, %rdx
	movzwl	4282(%rcx,%rdx), %ebx
	movb	_m+4330(%rip), %r10b
	testb	$1, %r10b
	movl	%r8d, %r14d
	cmovnel	%r11d, %r14d
	movslq	%r14d, %rdx
	movzwl	4282(%rcx,%rdx), %r14d
	xorl	%r14d, %ebx
	movw	%bx, %r15w
	movb	_m+4330(%rip), %r10b
	testb	$1, %r10b
...
LBB0_17:
	...
	movq	%rsi, %rdi
	addq	$5106, %rdi             ## imm = 0x13F2
	addq	$4294, %rsi             ## imm = 0x10C6
	movl	$2, %eax
	xorl	%r8d, %r8d
	movslq	_m+5102(%rip), %r9
	subq	$2, %r9
	movl	%r9d, %r10d
	movl	%r10d, _m+5102(%rip)
	movb	_m+4330(%rip), %r11b
	testb	$1, %r11b
	cmovnel	%r8d, %eax
	movslq	%eax, %r9
	addq	%r9, %rsi
	...
	cmovnel	%r10d, %ebx
	movslq	%ebx, %rdx
	movw	4282(%rcx,%rdx), %r14w
	movb	_m+4330(%rip), %r11b
	testb	$1, %r11b
	movl	%r8d, %ebx
	cmovnel	%r10d, %ebx
	movslq	%ebx, %rdx
	movw	%r14w, 4286(%rcx,%rdx)
	movb	_m+4330(%rip), %r11b
	testb	$1, %r11b
	movl	%r8d, %ebx
	cmovnel	%r10d, %ebx
...
LBB0_31:
	...
	cmovnel	%ecx, %edx
	movslq	%edx, %rdi
	movw	4282(%rax,%rdi), %r8w
	movb	_m+4330(%rip), %sil
	testb	$1, %sil
	cmovnel	%ecx, %ecx
	movslq	%ecx, %rdi
	movw	%r8w, 4318(%rax,%rdi)
	movzwl	_m+4316(%rip), %ecx
	movl	%ecx, %edi
	movl	21494(%rax,%rdi,4), %ecx
	movl	%ecx, %edi
	movb	$55, (%rax,%rdi)
...
LBB0_35:
	...
	movq	%rsi, %rdi
	addq	$5106, %rdi             ## imm = 0x13F2
	addq	$4316, %rsi             ## imm = 0x10DC
	xorl	%r10d, %r10d
	movslq	_m+5102(%rip), %r8
	addq	$2, %r8
	movl	%r8d, %r11d
	movl	%r11d, _m+5102(%rip)
	movslq	_m+5102(%rip), %r8
	subq	$2, %r8
	movl	%r8d, %r11d
	movl	%r11d, _m+5102(%rip)
	...
	callq	___memcpy_chk
	movl	$5, _m+4302(%rip)
	movl	_m+4302(%rip), %r10d
	subl	_m+4298(%rip), %r10d
	cmpl	$0, %r10d
	sete	%r9b
	andb	$1, %r9b
	movb	%r9b, _m+4327(%rip)
	movl	_m+4302(%rip), %r10d
	cmpl	_m+4298(%rip), %r10d
	setb	%r9b
	andb	$1, %r9b
	movb	%r9b, _m+4326(%rip)
	movl	_m+4302(%rip), %r10d
	subl	_m+4298(%rip), %r10d
	shrl	$31, %r10d
	cmpl	$0, %r10d
...
LBB1_44:
	...
	movl	_m+21490(%rip), %eax
	movl	%eax, _m+4282(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+21490(%rip), %eax
	movl	%eax, _m+21490(%rip)
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21490(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280314, 21494(%rax,%rdx,4) ## imm = 0x414FFA
	movl	_m+21490(%rip), %ecx
	movl	%ecx, _m+4282(%rip)
	movl	_m+4282(%rip), %esi
	movb	$0, %al
...
LBB1_51:
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzwl	4294(%rax,%r9), %r8d
	andl	$65535, %r8d            ## imm = 0xFFFF
	movb	_m+4330(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movzwl	4290(%rax,%r9), %ecx
	shll	$16, %ecx
	addl	%ecx, %r8d
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	%r8d, 21494(%rax,%r9,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	21494(%rax,%r9,4), %edx
	movb	$0, %al
	callq	_printf
