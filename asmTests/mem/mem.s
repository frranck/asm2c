...
## BB#3:
	...
	movb	$0, _m+49(%rip)
	movslq	_m+5618(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5618(%rip)
	movq	%rax, %r8
	movslq	_m+5618(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_29:
	...
	subq	$2, %rcx
	movl	%ecx, %edx
	movl	%edx, _m+5618(%rip)
	movslq	_m+5618(%rip), %rcx
	movw	5622(%rax,%rcx,4), %si
	movw	%si, _m+12(%rip)
	movslq	_m+5618(%rip), %rcx
	subq	$2, %rcx
	movl	%ecx, %edx
