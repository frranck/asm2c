...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$4927, %rdi             ## imm = 0x133F
	movb	$0, _m+4152(%rip)
	movslq	_m+4923(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+4923(%rip)
	movq	%rax, %r8
	movslq	_m+4923(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_4:
	leaq	_m(%rip), %rax
	movb	$0, _m+4149(%rip)
	movzwl	_m+4137(%rip), %ecx
	movl	%ecx, %edx
	movl	21315(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
	movzbl	(%rax,%rdx), %ecx
	subl	$1, %ecx
	cmpl	$0, %ecx
...
LBB0_6:
	...
	xorl	%edx, %edx
	movl	$1, _m+4103(%rip)
	movzwl	_m+4137(%rip), %esi
	movl	%esi, %edi
	movl	21315(%rax,%rdi,4), %esi
	movl	%esi, %edi
	movzbl	(%rax,%rdi), %esi
	movb	_m+4151(%rip), %r8b
	testb	$1, %r8b
	movl	%ecx, %r9d
	cmovnel	%edx, %r9d
	movslq	%r9d, %rdi
	movzbl	4103(%rax,%rdi), %r9d
	subl	%r9d, %esi
	cmpl	$0, %esi
	sete	%r8b
	andb	$1, %r8b
	movb	%r8b, _m+4148(%rip)
	movzwl	_m+4137(%rip), %esi
	movl	%esi, %edi
	movl	21315(%rax,%rdi,4), %esi
	movl	%esi, %edi
	...
	cmovnel	%edx, %ecx
	movslq	%ecx, %rdi
	movzbl	4103(%rax,%rdi), %ecx
	subl	%ecx, %esi
	sarl	$7, %esi
	cmpl	$0, %esi
	setne	%r8b
	andb	$1, %r8b
	movb	%r8b, _m+4150(%rip)
	testb	$1, _m+4148(%rip)
	jne	LBB0_8
## BB#7:
	jmp	LBB0_19
...
LBB0_10:
	...
	movl	21315(%rax,%rdi,4), %esi
	movl	%esi, %edi
	movzwl	1(%rax,%rdi), %esi
	movb	_m+4151(%rip), %r8b
	testb	$1, %r8b
	movl	%ecx, %r9d
	cmovnel	%edx, %r9d
	movslq	%r9d, %rdi
	movzwl	4107(%rax,%rdi), %r9d
	subl	%r9d, %esi
	cmpl	$0, %esi
	sete	%r8b
	andb	$1, %r8b
...
LBB0_16:
	...
	cmovnel	%edi, %r9d
	movslq	%r9d, %r10
	movzbl	4103(%rax,%r10), %r9d
	movb	_m+4151(%rip), %r8b
	testb	$1, %r8b
	movl	%ecx, %r11d
	cmovnel	%edx, %r11d
	movslq	%r11d, %r10
	movzbl	4103(%rax,%r10), %r11d
	subl	%r11d, %r9d
	cmpl	$0, %r9d
	sete	%r8b
	andb	$1, %r8b
	...
	cmovnel	%edi, %esi
	movslq	%esi, %r10
	movzbl	4103(%rax,%r10), %esi
	movb	_m+4151(%rip), %r8b
	testb	$1, %r8b
	cmovnel	%edx, %ecx
	movslq	%ecx, %r10
	movzbl	4103(%rax,%r10), %ecx
	subl	%ecx, %esi
	sarl	$7, %esi
	cmpl	$0, %esi
	setne	%r8b
...
## BB#22:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+4923(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+4923(%rip)
...
LBB1_10:
	jmp	LBB1_61
LBB1_11:
	movl	$512, _m+4115(%rip)     ## imm = 0x200
	jmp	LBB1_61
LBB1_12:
	cmpq	$0, _m+4408135(%rip)
	je	LBB1_14
## BB#13:
	xorl	%esi, %esi
	...
	leaq	_m(%rip), %rdi
	leaq	-1008(%rbp), %r8
	movq	_m+4408135(%rip), %r9
	movl	_m+4115(%rip), %eax
	movl	%eax, %r10d
	movq	%rdi, %r11
	addq	%r10, %r11
	movzwl	_m+4137(%rip), %eax
	movl	%eax, %r10d
	movl	21315(%rdi,%r10,4), %eax
	movl	%eax, %edi
	addq	%rdi, %r11
	movq	%r8, %rdi
	movq	%r9, %r8
...
LBB1_22:
	...
	addq	%rax, %rsi
	movq	%rsi, -1048(%rbp)
	movl	_m+4111(%rip), %esi
	movzwl	-1024(%rbp), %edx
	movzwl	_m+4137(%rip), %ecx
	movl	_m+4115(%rip), %r8d
	movq	-1048(%rbp), %r9
	movq	_asm2C_INT.file(%rip), %rax
	movq	%rax, (%rsp)
	movb	$0, %al
...
LBB1_44:
	...
	movl	_m+21311(%rip), %eax
	movl	%eax, _m+4103(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+21311(%rip), %eax
	movl	%eax, _m+21311(%rip)
	movl	_m+4103(%rip), %esi
	movb	$0, %al
	callq	_printf
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21311(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280135, 21315(%rax,%rdx,4) ## imm = 0x414F47
	movl	_m+21311(%rip), %ecx
	movl	%ecx, _m+4103(%rip)
	movl	_m+4103(%rip), %esi
	movb	$0, %al
	...
	movl	_m+21311(%rip), %ecx
	addl	$1, %ecx
	movl	%ecx, _m+21311(%rip)
	movl	%eax, -1256(%rbp)       ## 4-byte Spill
	jmp	LBB1_61
LBB1_49:
	leaq	L_.str.63(%rip), %rdi
	movl	_m+4107(%rip), %esi
	movl	_m+4115(%rip), %edx
	movl	_m+4111(%rip), %ecx
	movb	$0, %al
	callq	_printf
	movzwl	-1022(%rbp), %ecx
	cmpl	_m+21311(%rip), %ecx
...
LBB1_51:
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzwl	4115(%rax,%r9), %r8d
	andl	$65535, %r8d            ## imm = 0xFFFF
	movb	_m+4151(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movzwl	4111(%rax,%r9), %ecx
	shll	$16, %ecx
	addl	%ecx, %r8d
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	%r8d, 21315(%rax,%r9,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	21315(%rax,%r9,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB1_55:
	...
	movl	_m+21827(%rip), %eax
	movl	%eax, %ecx
	addq	$21831, %rcx            ## imm = 0x5547
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21827(%rip), %eax
	movl	%eax, _m+21827(%rip)
	movl	_m+21827(%rip), %eax
	movl	%eax, %ecx
	addq	$21831, %rcx            ## imm = 0x5547
	movl	%ecx, %eax
	...
	movl	%esi, _m+4111(%rip)
	movl	-1080(%rbp), %esi
	shrl	$16, %esi
	movl	%esi, _m+4107(%rip)
	movl	$0, _m+4123(%rip)
	movl	$0, _m+4119(%rip)
	movl	-1080(%rbp), %esi
	movl	_m+4107(%rip), %edx
	movl	_m+4111(%rip), %ecx
...
Ltmp11:
	...
	movl	_m+4115(%rip), %esi
	movl	%eax, -36(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.13(%rip), %rdi
	movl	_m+4127(%rip), %esi
	movl	%eax, -40(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.14(%rip), %rdi
	leaq	_m(%rip), %rdx
	movzwl	_m+4135(%rip), %esi
	movzwl	_m+4135(%rip), %ecx
	movl	%ecx, %r8d
	movl	21315(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	movl	_m+4119(%rip), %esi
	movl	%eax, -52(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.17(%rip), %rdi
	leaq	_m(%rip), %rdx
	movl	_m+4119(%rip), %ecx
	movl	%ecx, %r8d
	movq	%rdx, %r9
	addq	%r8, %r9
	movzwl	_m+4137(%rip), %ecx
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4139(%rip), %esi
	movzwl	_m+4139(%rip), %ecx
	movl	%ecx, %r8d
	movl	21315(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	callq	_printf
	leaq	_m(%rip), %rdx
	addq	$4139, %rdx             ## imm = 0x102B
	movl	$4, %esi
	movq	%rdx, %rdi
	movl	%eax, -64(%rbp)         ## 4-byte Spill
	callq	_hexDump
	leaq	L_.str.19(%rip), %rdi
	movl	_m+4123(%rip), %esi
	movb	$0, %al
	callq	_printf
	leaq	L_.str.20(%rip), %rdi
	leaq	_m(%rip), %rdx
	movl	_m+4123(%rip), %ecx
	movl	%ecx, %r8d
	movq	%rdx, %r9
	addq	%r8, %r9
	movzwl	_m+4139(%rip), %ecx
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4141(%rip), %esi
	movzwl	_m+4141(%rip), %eax
	movl	%eax, %r8d
	movl	21315(%rdx,%r8,4), %eax
	movl	%eax, %r8d
	addq	%r8, %rdx
	movb	$0, %al
	callq	_printf
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4143(%rip), %esi
	movzwl	_m+4143(%rip), %ecx
	movl	%ecx, %r8d
	movl	21315(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	leaq	_m(%rip), %rdx
	addq	$4280135, %rdx          ## imm = 0x414F47
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.25(%rip), %rdi
	movzbl	_m+4280135(%rip), %esi
	movl	%eax, -88(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.26(%rip), %rdi
	movb	_m+4148(%rip), %r10b
	andb	$1, %r10b
	movzbl	%r10b, %esi
