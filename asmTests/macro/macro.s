...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$4972, %rdi             ## imm = 0x136C
	movb	$0, _m+4197(%rip)
	movslq	_m+4968(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+4968(%rip)
	movq	%rax, %r8
	movslq	_m+4968(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
	...
	callq	_longjmp
LBB0_4:
	movl	$123, _m+4149(%rip)
	movl	$0, _m+4149(%rip)
	movl	_m+4149(%rip), %eax
	subl	$0, %eax
	cmpl	$0, %eax
	sete	%cl
	andb	$1, %cl
...
LBB0_6:
	leaq	_m(%rip), %rax
	addq	$4972, %rax             ## imm = 0x136C
	movl	$122, _m+4149(%rip)
	movslq	_m+4968(%rip), %rcx
	shlq	$2, %rcx
	addq	%rcx, %rax
	...
	callq	___memcpy_chk
	leaq	_m(%rip), %rcx
	addq	$4972, %rcx             ## imm = 0x136C
	movslq	_m+4968(%rip), %rdx
	addq	$2, %rdx
	movl	%edx, %r8d
	movl	%r8d, _m+4968(%rip)
	movslq	_m+4968(%rip), %rdx
	shlq	$2, %rdx
	addq	%rdx, %rcx
	...
	movl	%r8d, _m+4968(%rip)
	movslq	_m+4968(%rip), %rdx
	movl	4972(%rcx,%rdx,4), %r8d
	movl	%r8d, _m+4153(%rip)
	movslq	_m+4968(%rip), %rdx
	subq	$4, %rdx
	movl	%edx, %r8d
	movl	%r8d, _m+4968(%rip)
	...
	cmovnel	%r8d, %r8d
	movslq	%r8d, %rdx
	movslq	_m+4968(%rip), %rsi
	movw	4972(%rcx,%rsi,4), %r11w
	movw	%r11w, 4183(%rcx,%rdx)
	movslq	_m+4968(%rip), %rcx
	subq	$2, %rcx
	movl	%ecx, %r8d
	movl	%r8d, _m+4968(%rip)
	...
	movslq	_m+4968(%rip), %rsi
	movw	4972(%rcx,%rsi,4), %r11w
	movw	%r11w, 4185(%rcx,%rdx)
	movl	_m+4149(%rip), %r8d
	subl	$122, %r8d
	cmpl	$0, %r8d
	sete	%al
	andb	$1, %al
	movb	%al, _m+4194(%rip)
	cmpl	$122, _m+4149(%rip)
	setb	%al
	andb	$1, %al
	movb	%al, _m+4193(%rip)
	movl	_m+4149(%rip), %r8d
...
LBB0_11:                                ## =>This Inner Loop Header: Depth=1
	movl	_m+4161(%rip), %eax
	addl	$1, %eax
	movl	%eax, _m+4161(%rip)
	cmpl	$0, _m+4161(%rip)
	sete	%cl
	andb	$1, %cl
	movb	%cl, _m+4194(%rip)
	movl	_m+4157(%rip), %eax
	subl	$1, %eax
	movl	%eax, _m+4157(%rip)
	cmpl	$0, _m+4157(%rip)
	sete	%cl
	andb	$1, %cl
	movb	%cl, _m+4194(%rip)
...
LBB0_18:
	leaq	_m(%rip), %rax
	movzwl	_m+4183(%rip), %ecx
	movl	%ecx, %edx
	movl	21360(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
	movzbl	(%rax,%rdx), %ecx
	addl	$1, %ecx
	movb	%cl, %sil
	...
	sete	%sil
	andb	$1, %sil
	movb	%sil, _m+4194(%rip)
	movl	$0, _m+4169(%rip)
	movl	_m+4169(%rip), %ecx
	addl	$3, %ecx
	movl	%ecx, %ecx
	movl	%ecx, %edx
	movq	%rax, %rdi
...
LBB2_10:
	jmp	LBB2_61
LBB2_11:
	movl	$512, _m+4161(%rip)     ## imm = 0x200
	jmp	LBB2_61
LBB2_12:
	cmpq	$0, _m+4408180(%rip)
	je	LBB2_14
## BB#13:
	xorl	%esi, %esi
	...
	leaq	_m(%rip), %rdi
	leaq	-1008(%rbp), %r8
	movq	_m+4408180(%rip), %r9
	movl	_m+4161(%rip), %eax
	movl	%eax, %r10d
	movq	%rdi, %r11
	addq	%r10, %r11
	movzwl	_m+4183(%rip), %eax
	movl	%eax, %r10d
	movl	21360(%rdi,%r10,4), %eax
	movl	%eax, %edi
	addq	%rdi, %r11
	movq	%r8, %rdi
	movq	%r9, %r8
...
LBB2_22:
	...
	addq	%rax, %rsi
	movq	%rsi, -1048(%rbp)
	movl	_m+4157(%rip), %esi
	movzwl	-1020(%rbp), %edx
	movzwl	_m+4183(%rip), %ecx
	movl	_m+4161(%rip), %r8d
	movq	-1048(%rbp), %r9
	movq	_asm2C_INT.file(%rip), %rax
	movq	%rax, (%rsp)
	movb	$0, %al
...
LBB2_44:
	...
	movl	_m+21356(%rip), %eax
	movl	%eax, _m+4149(%rip)
	movzwl	-1020(%rbp), %eax
	addl	_m+21356(%rip), %eax
	movl	%eax, _m+21356(%rip)
	movl	_m+4149(%rip), %esi
	movb	$0, %al
	callq	_printf
...
LBB2_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21356(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280180, 21360(%rax,%rdx,4) ## imm = 0x414F74
	movl	_m+21356(%rip), %ecx
	movl	%ecx, _m+4149(%rip)
	movl	_m+4149(%rip), %esi
	movb	$0, %al
	...
	movl	_m+21356(%rip), %ecx
	addl	$1, %ecx
	movl	%ecx, _m+21356(%rip)
	movl	%eax, -1264(%rbp)       ## 4-byte Spill
	jmp	LBB2_61
LBB2_49:
	leaq	L_.str.58(%rip), %rdi
	movl	_m+4153(%rip), %esi
	movl	_m+4161(%rip), %edx
	movl	_m+4157(%rip), %ecx
	movb	$0, %al
	callq	_printf
	movzwl	-1018(%rbp), %ecx
	cmpl	_m+21356(%rip), %ecx
...
LBB2_51:
	...
	cmovnel	%esi, %edx
	movslq	%edx, %r8
	movzwl	4157(%rcx,%r8), %edx
	shll	$16, %edx
	movl	-1276(%rbp), %esi       ## 4-byte Reload
	addl	%edx, %esi
	movzwl	-1018(%rbp), %edx
	movl	%edx, %r8d
	movl	%esi, 21360(%rcx,%r8,4)
	movzwl	-1018(%rbp), %esi
	movzwl	-1018(%rbp), %edx
	movl	%edx, %r8d
	movl	21360(%rcx,%r8,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB2_55:
	...
	movl	_m+21872(%rip), %eax
	movl	%eax, %ecx
	addq	$21876, %rcx            ## imm = 0x5574
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21872(%rip), %eax
	movl	%eax, _m+21872(%rip)
	movl	_m+21872(%rip), %eax
	movl	%eax, %ecx
	addq	$21876, %rcx            ## imm = 0x5574
	movl	%ecx, %eax
	...
	movl	%esi, _m+4157(%rip)
	movl	-1080(%rbp), %esi
	shrl	$16, %esi
	movl	%esi, _m+4153(%rip)
	movl	$0, _m+4169(%rip)
	movl	$0, _m+4165(%rip)
	movl	-1080(%rbp), %esi
	movl	_m+4153(%rip), %edx
	movl	_m+4157(%rip), %ecx
...
Ltmp11:
	...
	movl	_m+4161(%rip), %esi
	movl	%eax, -36(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.10(%rip), %rdi
	movl	_m+4173(%rip), %esi
	movl	%eax, -40(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.11(%rip), %rdi
	leaq	_m(%rip), %rdx
	movzwl	_m+4181(%rip), %esi
	movzwl	_m+4181(%rip), %ecx
	movl	%ecx, %r8d
	movl	21360(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	movl	_m+4165(%rip), %esi
	movl	%eax, -52(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.14(%rip), %rdi
	leaq	_m(%rip), %rdx
	movl	_m+4165(%rip), %ecx
	movl	%ecx, %r8d
	movq	%rdx, %r9
	addq	%r8, %r9
	movzwl	_m+4183(%rip), %ecx
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4185(%rip), %esi
	movzwl	_m+4185(%rip), %ecx
	movl	%ecx, %r8d
	movl	21360(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	callq	_printf
	leaq	_m(%rip), %rdx
	addq	$4185, %rdx             ## imm = 0x1059
	movl	$4, %esi
	movq	%rdx, %rdi
	movl	%eax, -64(%rbp)         ## 4-byte Spill
	callq	_hexDump
	leaq	L_.str.16(%rip), %rdi
	movl	_m+4169(%rip), %esi
	movb	$0, %al
	callq	_printf
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4187(%rip), %esi
	movzwl	_m+4187(%rip), %eax
	movl	%eax, %r8d
	movl	21360(%rdx,%r8,4), %eax
	movl	%eax, %r8d
	addq	%r8, %rdx
	movb	$0, %al
	callq	_printf
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4189(%rip), %esi
	movzwl	_m+4189(%rip), %ecx
	movl	%ecx, %r8d
	movl	21360(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	leaq	_m(%rip), %rdx
	addq	$4280180, %rdx          ## imm = 0x414F74
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.22(%rip), %rdi
	movzbl	_m+4280180(%rip), %esi
	movl	%eax, -88(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.23(%rip), %rdi
	movb	_m+4194(%rip), %r10b
	andb	$1, %r10b
	movzbl	%r10b, %esi
