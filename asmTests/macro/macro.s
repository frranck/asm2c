...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$4973, %rdi             ## imm = 0x136D
	movb	$0, _m+4198(%rip)
	movslq	_m+4969(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+4969(%rip)
	movq	%rax, %r8
	movslq	_m+4969(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_6:
	...
	leaq	_m(%rip), %rsi
	movq	%rsi, %rdi
	addq	$4185, %rdi             ## imm = 0x1059
	xorl	%eax, %eax
	addq	$4973, %rsi             ## imm = 0x136D
	movl	$122, _m+4149(%rip)
	movslq	_m+4969(%rip), %r8
	shlq	$2, %r8
	addq	%r8, %rsi
	movb	_m+4197(%rip), %r9b
	testb	$1, %r9b
	cmovnel	%eax, %eax
	movslq	%eax, %r8
	addq	%r8, %rdi
	...
	leaq	_m(%rip), %rsi
	movq	%rsi, %rdi
	addq	$4183, %rdi             ## imm = 0x1057
	xorl	%r10d, %r10d
	addq	$4973, %rsi             ## imm = 0x136D
	movslq	_m+4969(%rip), %r8
	addq	$2, %r8
	movl	%r8d, %r11d
	movl	%r11d, _m+4969(%rip)
	movslq	_m+4969(%rip), %r8
	shlq	$2, %r8
	addq	%r8, %rsi
	movb	_m+4197(%rip), %r9b
	...
	movl	%r10d, %esi
	movq	$-1, %rdi
	addq	$4973, %rcx             ## imm = 0x136D
	movslq	_m+4969(%rip), %r8
	addq	$2, %r8
	movl	%r8d, %r10d
	movl	%r10d, _m+4969(%rip)
	movslq	_m+4969(%rip), %r8
	shlq	$2, %r8
	addq	%r8, %rcx
	...
	addq	$4973, %rdi             ## imm = 0x136D
	movq	%rsi, %r8
	addq	$4183, %r8              ## imm = 0x1057
	xorl	%r10d, %r10d
	movslq	_m+4969(%rip), %rbx
	addq	$4, %rbx
	movl	%ebx, %r11d
	movl	%r11d, _m+4969(%rip)
	movslq	_m+4969(%rip), %rbx
	...
	movl	%r11d, _m+4969(%rip)
	movslq	_m+4969(%rip), %rbx
	movl	4973(%rsi,%rbx,4), %r11d
	movl	%r11d, _m+4153(%rip)
	movslq	_m+4969(%rip), %rbx
	subq	$4, %rbx
	movl	%ebx, %r11d
	movl	%r11d, _m+4969(%rip)
	movslq	_m+4969(%rip), %rbx
	movl	4973(%rsi,%rbx,4), %r11d
	movl	%r11d, _m+4149(%rip)
	movslq	_m+4969(%rip), %rsi
	subq	$2, %rsi
	movl	%esi, %r11d
	movl	%r11d, _m+4969(%rip)
	movb	_m+4197(%rip), %r9b
	...
	callq	___memcpy_chk
	movl	_m+4149(%rip), %r10d
	subl	$122, %r10d
	cmpl	$0, %r10d
	sete	%r9b
	andb	$1, %r9b
	movb	%r9b, _m+4194(%rip)
	cmpl	$122, _m+4149(%rip)
	setb	%r9b
	andb	$1, %r9b
	movb	%r9b, _m+4193(%rip)
	movl	_m+4149(%rip), %r10d
	subl	$122, %r10d
	shrl	$31, %r10d
	cmpl	$0, %r10d
...
LBB0_18:
	...
	movl	%esi, %edi
	movb	(%r9,%rdi), %r8b
	movb	_m+4197(%rip), %r10b
	testb	$1, %r10b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	movslq	%esi, %rdi
	movb	%r8b, 4149(%rax,%rdi)
	movb	_m+4197(%rip), %r8b
	testb	$1, %r8b
	cmovnel	%edx, %ecx
	movslq	%ecx, %rdi
	movb	$0, 4149(%rax,%rdi)
...
## BB#22:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+4969(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+4969(%rip)
...
LBB1_44:
	...
	movl	_m+21357(%rip), %eax
	movl	%eax, _m+4149(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+21357(%rip), %eax
	movl	%eax, _m+21357(%rip)
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21357(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280181, 21361(%rax,%rdx,4) ## imm = 0x414F75
	movl	_m+21357(%rip), %ecx
	movl	%ecx, _m+4149(%rip)
	movl	_m+4149(%rip), %esi
	movb	$0, %al
...
LBB1_51:
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzwl	4161(%rax,%r9), %r8d
	andl	$65535, %r8d            ## imm = 0xFFFF
	movb	_m+4197(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movzwl	4157(%rax,%r9), %ecx
	shll	$16, %ecx
	addl	%ecx, %r8d
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	%r8d, 21361(%rax,%r9,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	21361(%rax,%r9,4), %edx
	movb	$0, %al
	callq	_printf
...
Ltmp12:
	...
	leaq	_m(%rip), %rdx
	addq	$4280181, %rdx          ## imm = 0x414F75
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.25(%rip), %rdi
	movzbl	_m+4280181(%rip), %esi
