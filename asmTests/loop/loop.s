...
## BB#13:
	...
	leaq	_m(%rip), %rdi
	addq	$1340, %rdi             ## imm = 0x53C
	movl	_m+1336(%rip), %eax
	movl	%eax, %r8d
	shlq	$2, %r8
	addq	%r8, %rdi
	callq	___memcpy_chk
	movl	_m+1336(%rip), %r9d
	movl	%r9d, %ecx
	addq	$148, %rcx
	movl	%ecx, %r9d
