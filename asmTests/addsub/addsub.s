...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$5085, %rdi             ## imm = 0x13DD
	movb	$0, _m+4310(%rip)
	movslq	_m+5081(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5081(%rip)
	movq	%rax, %r8
	movslq	_m+5081(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_31:
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzbl	4273(%rax,%r9), %r8d
	subl	$97, %r8d
	movb	%r8b, %dil
	movb	_m+4309(%rip), %r10b
	testb	$1, %r10b
	movl	%ecx, %r8d
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movb	%dil, 4273(%rax,%r9)
	movb	_m+4309(%rip), %dil
	testb	$1, %dil
	movl	%ecx, %r8d
	cmovnel	%edx, %r8d
...
LBB0_33:
	...
	xorl	_m+4281(%rip), %esi
	movl	%esi, _m+4281(%rip)
	cmpl	$0, _m+4281(%rip)
	sete	%dil
	andb	$1, %dil
	movb	%dil, _m+4306(%rip)
...
## BB#37:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+5081(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+5081(%rip)
...
LBB1_44:
	...
	movl	_m+21469(%rip), %eax
	movl	%eax, _m+4261(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+21469(%rip), %eax
	movl	%eax, _m+21469(%rip)
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21469(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280293, 21473(%rax,%rdx,4) ## imm = 0x414FE5
	movl	_m+21469(%rip), %ecx
	movl	%ecx, _m+4261(%rip)
	movl	_m+4261(%rip), %esi
	movb	$0, %al
...
LBB1_51:
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzwl	4273(%rax,%r9), %r8d
	andl	$65535, %r8d            ## imm = 0xFFFF
	movb	_m+4309(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movzwl	4269(%rax,%r9), %ecx
	shll	$16, %ecx
	addl	%ecx, %r8d
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	%r8d, 21473(%rax,%r9,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	21473(%rax,%r9,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB1_55:
	...
	movl	_m+21985(%rip), %eax
	movl	%eax, %ecx
	addq	$21989, %rcx            ## imm = 0x55E5
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21985(%rip), %eax
	movl	%eax, _m+21985(%rip)
	movl	_m+21985(%rip), %eax
	movl	%eax, %ecx
	addq	$21989, %rcx            ## imm = 0x55E5
	movl	%ecx, %eax
...
Ltmp11:
	...
	leaq	_m(%rip), %rdx
	addq	$4280293, %rdx          ## imm = 0x414FE5
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.25(%rip), %rdi
	movzbl	_m+4280293(%rip), %esi
