...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$5601, %rdi             ## imm = 0x15E1
	movb	$0, _m+49(%rip)
	movl	_m+5597(%rip), %ecx
	movl	%ecx, %r8d
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5597(%rip)
	movq	%rax, %r8
	movl	_m+5597(%rip), %ecx
	movl	%ecx, %r9d
	shlq	$2, %r9
...
LBB0_4:
	...
	movl	%ecx, %edx
	movl	5085(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
	movzwl	179(%rax,%rdx), %ecx
	addl	$50, %ecx
	movw	%cx, %si
	movzwl	_m+34(%rip), %ecx
	movl	%ecx, %edx
...
LBB0_6:
	...
	movl	%edx, %esi
	movl	5085(%rax,%rsi,4), %edx
	movl	%edx, %esi
	movzwl	179(%rax,%rsi), %edx
	subl	$25, %edx
	movw	%dx, %di
	movzwl	_m+34(%rip), %edx
	movl	%edx, %esi
	...
	movzwl	_m+34(%rip), %ecx
	movl	%ecx, %esi
	movl	5085(%rax,%rsi,4), %ecx
	movl	%ecx, %esi
	movzwl	179(%rax,%rsi), %ecx
	sarl	$15, %ecx
	cmpl	$0, %ecx
	setne	%r8b
	andb	$1, %r8b
...
LBB0_33:
	...
	andb	$1, %cl
	movb	%cl, _m+45(%rip)
	cmpl	$4480, _m+20(%rip)      ## imm = 0x1180
	setb	%cl
	andb	$1, %cl
	movb	%cl, _m+44(%rip)
	movl	_m+20(%rip), %eax
...
## BB#37:
	...
	leaq	_m(%rip), %rdi
	addq	$5601, %rdi             ## imm = 0x15E1
	movl	_m+5597(%rip), %eax
	movl	%eax, %r8d
	shlq	$2, %r8
	addq	%r8, %rdi
	callq	___memcpy_chk
	movl	_m+5597(%rip), %r9d
	movl	%r9d, %ecx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+5597(%rip)
	movl	_m+5597(%rip), %r9d
	movl	%r9d, %ecx
...
LBB1_44:
	...
	movl	_m+5081(%rip), %eax
	movl	%eax, _m(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+5081(%rip), %eax
	movl	%eax, _m+5081(%rip)
	movl	_m(%rip), %esi
	movb	$0, %al
	callq	_log_debug2
## BB#45:
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+5081(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280293, 5085(%rax,%rdx,4) ## imm = 0x414FE5
	movl	_m+5081(%rip), %ecx
	movl	%ecx, _m(%rip)
	movl	_m(%rip), %esi
	movb	$0, %al
...
LBB1_51:
	...
	movzwl	-1022(%rbp), %edx
	movl	%edx, %esi
	movl	%ecx, 5085(%rax,%rsi,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r8d
	movl	5085(%rax,%r8,4), %edx
	movb	$0, %al
	callq	_log_debug2
	jmp	LBB1_61
LBB1_52:
