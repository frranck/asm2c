...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$4955, %rdi             ## imm = 0x135B
	movb	$0, _m+4180(%rip)
	movslq	_m+4951(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+4951(%rip)
	movq	%rax, %r8
	movslq	_m+4951(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
## BB#6:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+4951(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+4951(%rip)
...
LBB0_8:
	...
	movslq	%ecx, %rdi
	movb	$0, 4135(%rax,%rdi)
	movl	_m+4135(%rip), %ecx
	subl	$-256, %ecx
	cmpl	$0, %ecx
	sete	%sil
	andb	$1, %sil
	movb	%sil, _m+4176(%rip)
	cmpl	$-256, _m+4135(%rip)
	setb	%sil
	andb	$1, %sil
	movb	%sil, _m+4175(%rip)
	movl	_m+4135(%rip), %ecx
	subl	$-256, %ecx
	shrl	$31, %ecx
	cmpl	$0, %ecx
	setne	%sil
	andb	$1, %sil
	movb	%sil, _m+4178(%rip)
	testb	$1, _m+4176(%rip)
	jne	LBB0_10
## BB#9:
	jmp	LBB0_11
LBB0_10:
	movl	_m+4131(%rip), %eax
	xorl	_m+4131(%rip), %eax
	movl	%eax, _m+4131(%rip)
	cmpl	$0, _m+4131(%rip)
	sete	%cl
	andb	$1, %cl
	movb	%cl, _m+4176(%rip)
...
LBB1_6:
	leaq	_m(%rip), %rax
	movl	_m+4143(%rip), %ecx
	movl	%ecx, %edx
	movq	%rax, %rsi
	addq	%rdx, %rsi
	movzwl	_m+4165(%rip), %ecx
	movl	%ecx, %edx
	movl	21343(%rax,%rdx,4), %ecx
	movl	%ecx, %eax
	addq	%rax, %rsi
	movq	%rsi, -1040(%rbp)
	movl	$0, -1016(%rbp)
...
LBB1_10:
	jmp	LBB1_61
LBB1_11:
	movl	$512, _m+4143(%rip)     ## imm = 0x200
	jmp	LBB1_61
LBB1_12:
	cmpq	$0, _m+4408163(%rip)
	je	LBB1_14
## BB#13:
	xorl	%esi, %esi
	...
	leaq	_m(%rip), %rdi
	leaq	-1008(%rbp), %r8
	movq	_m+4408163(%rip), %r9
	movl	_m+4143(%rip), %eax
	movl	%eax, %r10d
	movq	%rdi, %r11
	addq	%r10, %r11
	movzwl	_m+4165(%rip), %eax
	movl	%eax, %r10d
	movl	21343(%rdi,%r10,4), %eax
	movl	%eax, %edi
	addq	%rdi, %r11
	movq	%r8, %rdi
	movq	%r9, %r8
...
LBB1_22:
	...
	addq	%rax, %rsi
	movq	%rsi, -1048(%rbp)
	movl	_m+4139(%rip), %esi
	movzwl	-1024(%rbp), %edx
	movzwl	_m+4165(%rip), %ecx
	movl	_m+4143(%rip), %r8d
	movq	-1048(%rbp), %r9
	movq	_asm2C_INT.file(%rip), %rax
	movq	%rax, (%rsp)
	movb	$0, %al
...
LBB1_44:
	...
	movl	_m+21339(%rip), %eax
	movl	%eax, _m+4131(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+21339(%rip), %eax
	movl	%eax, _m+21339(%rip)
	movl	_m+4131(%rip), %esi
	movb	$0, %al
	callq	_printf
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21339(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280163, 21343(%rax,%rdx,4) ## imm = 0x414F63
	movl	_m+21339(%rip), %ecx
	movl	%ecx, _m+4131(%rip)
	movl	_m+4131(%rip), %esi
	movb	$0, %al
	...
	movl	_m+21339(%rip), %ecx
	addl	$1, %ecx
	movl	%ecx, _m+21339(%rip)
	movl	%eax, -1256(%rbp)       ## 4-byte Spill
	jmp	LBB1_61
LBB1_49:
	leaq	L_.str.63(%rip), %rdi
	movl	_m+4135(%rip), %esi
	movl	_m+4143(%rip), %edx
	movl	_m+4139(%rip), %ecx
	movb	$0, %al
	callq	_printf
	movzwl	-1022(%rbp), %ecx
	cmpl	_m+21339(%rip), %ecx
...
LBB1_51:
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzwl	4143(%rax,%r9), %r8d
	andl	$65535, %r8d            ## imm = 0xFFFF
	movb	_m+4179(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movzwl	4139(%rax,%r9), %ecx
	shll	$16, %ecx
	addl	%ecx, %r8d
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	%r8d, 21343(%rax,%r9,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	21343(%rax,%r9,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB1_55:
	...
	movl	_m+21855(%rip), %eax
	movl	%eax, %ecx
	addq	$21859, %rcx            ## imm = 0x5563
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21855(%rip), %eax
	movl	%eax, _m+21855(%rip)
	movl	_m+21855(%rip), %eax
	movl	%eax, %ecx
	addq	$21859, %rcx            ## imm = 0x5563
	movl	%ecx, %eax
	...
	movl	%esi, _m+4139(%rip)
	movl	-1080(%rbp), %esi
	shrl	$16, %esi
	movl	%esi, _m+4135(%rip)
	movl	$0, _m+4151(%rip)
	movl	$0, _m+4147(%rip)
	movl	-1080(%rbp), %esi
	movl	_m+4135(%rip), %edx
	movl	_m+4139(%rip), %ecx
...
Ltmp11:
	...
	movl	_m+4143(%rip), %esi
	movl	%eax, -36(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.13(%rip), %rdi
	movl	_m+4155(%rip), %esi
	movl	%eax, -40(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.14(%rip), %rdi
	leaq	_m(%rip), %rdx
	movzwl	_m+4163(%rip), %esi
	movzwl	_m+4163(%rip), %ecx
	movl	%ecx, %r8d
	movl	21343(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	movl	_m+4147(%rip), %esi
	movl	%eax, -52(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.17(%rip), %rdi
	leaq	_m(%rip), %rdx
	movl	_m+4147(%rip), %ecx
	movl	%ecx, %r8d
	movq	%rdx, %r9
	addq	%r8, %r9
	movzwl	_m+4165(%rip), %ecx
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4167(%rip), %esi
	movzwl	_m+4167(%rip), %ecx
	movl	%ecx, %r8d
	movl	21343(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	callq	_printf
	leaq	_m(%rip), %rdx
	addq	$4167, %rdx             ## imm = 0x1047
	movl	$4, %esi
	movq	%rdx, %rdi
	movl	%eax, -64(%rbp)         ## 4-byte Spill
	callq	_hexDump
	leaq	L_.str.19(%rip), %rdi
	movl	_m+4151(%rip), %esi
	movb	$0, %al
	callq	_printf
	leaq	L_.str.20(%rip), %rdi
	leaq	_m(%rip), %rdx
	movl	_m+4151(%rip), %ecx
	movl	%ecx, %r8d
	movq	%rdx, %r9
	addq	%r8, %r9
	movzwl	_m+4167(%rip), %ecx
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4169(%rip), %esi
	movzwl	_m+4169(%rip), %eax
	movl	%eax, %r8d
	movl	21343(%rdx,%r8,4), %eax
	movl	%eax, %r8d
	addq	%r8, %rdx
	movb	$0, %al
	callq	_printf
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4171(%rip), %esi
	movzwl	_m+4171(%rip), %ecx
	movl	%ecx, %r8d
	movl	21343(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	leaq	_m(%rip), %rdx
	addq	$4280163, %rdx          ## imm = 0x414F63
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.25(%rip), %rdi
	movzbl	_m+4280163(%rip), %esi
	movl	%eax, -88(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.26(%rip), %rdi
	movb	_m+4176(%rip), %r10b
	andb	$1, %r10b
	movzbl	%r10b, %esi
