...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$5471, %rdi             ## imm = 0x155F
	movb	$0, _m+49(%rip)
	movl	_m+5467(%rip), %ecx
	movl	%ecx, %r8d
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5467(%rip)
	movq	%rax, %r8
	movl	_m+5467(%rip), %ecx
	movl	%ecx, %r9d
	shlq	$2, %r9
...
## BB#6:
	...
	leaq	_m(%rip), %rdi
	addq	$5471, %rdi             ## imm = 0x155F
	movl	_m+5467(%rip), %eax
	movl	%eax, %r8d
	shlq	$2, %r8
	addq	%r8, %rdi
	callq	___memcpy_chk
	movl	_m+5467(%rip), %r9d
	movl	%r9d, %ecx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+5467(%rip)
	movl	_m+5467(%rip), %r9d
	movl	%r9d, %ecx
...
LBB1_44:
	...
	movl	_m+4951(%rip), %eax
	movl	%eax, _m(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+4951(%rip), %eax
	movl	%eax, _m+4951(%rip)
	movl	_m(%rip), %esi
	movb	$0, %al
	callq	_log_debug2
## BB#45:
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+4951(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280163, 4955(%rax,%rdx,4) ## imm = 0x414F63
	movl	_m+4951(%rip), %ecx
	movl	%ecx, _m(%rip)
	movl	_m(%rip), %esi
	movb	$0, %al
...
LBB1_51:
	...
	movzwl	-1022(%rbp), %edx
	movl	%edx, %esi
	movl	%ecx, 4955(%rax,%rsi,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r8d
	movl	4955(%rax,%r8,4), %edx
	movb	$0, %al
	callq	_log_debug2
	jmp	LBB1_61
LBB1_52:
