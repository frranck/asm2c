...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$5006, %rdi             ## imm = 0x138E
	movb	$0, _m+4231(%rip)
	movslq	_m+5002(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5002(%rip)
	movq	%rax, %r8
	movslq	_m+5002(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
## BB#5:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+5002(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+5002(%rip)
...
LBB0_12:
	...
	movzwl	_m+4216(%rip), %esi
	movl	%esi, %edi
	movl	21394(%rax,%rdi,4), %esi
	movl	%esi, %edi
	movb	1(%rax,%rdi), %r8b
	movb	_m+4230(%rip), %r9b
	testb	$1, %r9b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	movslq	%esi, %rdi
	movb	%r8b, 4194(%rax,%rdi)
	movb	_m+4230(%rip), %r8b
	testb	$1, %r8b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	movslq	%esi, %rdi
	movzbl	4194(%rax,%rdi), %esi
	subl	$2, %esi
	cmpl	$0, %esi
	sete	%r8b
	andb	$1, %r8b
	movb	%r8b, _m+4227(%rip)
	movb	_m+4230(%rip), %r8b
	testb	$1, %r8b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	...
	setl	%r8b
	andb	$1, %r8b
	movb	%r8b, _m+4226(%rip)
	movb	_m+4230(%rip), %r8b
	testb	$1, %r8b
	cmovnel	%edx, %ecx
	movslq	%ecx, %rdi
	movzbl	4194(%rax,%rdi), %ecx
	subl	$2, %ecx
	sarl	$7, %ecx
	cmpl	$0, %ecx
	setne	%r8b
	andb	$1, %r8b
	movb	%r8b, _m+4229(%rip)
	testb	$1, _m+4227(%rip)
	jne	LBB0_14
## BB#13:
	jmp	LBB0_21
LBB0_14:
	...
	movl	%esi, %edi
	movb	(%r8,%rdi), %r9b
	movb	_m+4230(%rip), %r10b
	testb	$1, %r10b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	movslq	%esi, %rdi
	movb	%r9b, 4194(%rax,%rdi)
	movb	_m+4230(%rip), %r9b
	testb	$1, %r9b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
...
LBB0_16:
	...
	cmovnel	%edx, %esi
	movslq	%esi, %rdi
	movw	%r9w, 4194(%rax,%rdi)
	movb	_m+4230(%rip), %r10b
	testb	$1, %r10b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	movslq	%esi, %rdi
	movzwl	4194(%rax,%rdi), %esi
	subl	$11, %esi
	cmpl	$0, %esi
	sete	%r10b
	andb	$1, %r10b
	movb	%r10b, _m+4227(%rip)
	movb	_m+4230(%rip), %r10b
	testb	$1, %r10b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	...
	setl	%r10b
	andb	$1, %r10b
	movb	%r10b, _m+4226(%rip)
	movb	_m+4230(%rip), %r10b
	testb	$1, %r10b
	cmovnel	%edx, %ecx
	movslq	%ecx, %rdi
	movzwl	4194(%rax,%rdi), %ecx
	subl	$11, %ecx
	sarl	$15, %ecx
	cmpl	$0, %ecx
	setne	%r10b
	andb	$1, %r10b
	movb	%r10b, _m+4229(%rip)
	testb	$1, _m+4227(%rip)
	jne	LBB0_18
## BB#17:
	jmp	LBB0_21
...
LBB0_28:                                ## =>This Inner Loop Header: Depth=1
	...
	shll	$4, %esi
	movl	_m+4182(%rip), %edi
	shrl	$28, %edi
	orl	%edi, %esi
	movl	%esi, _m+4182(%rip)
	movb	_m+4230(%rip), %r8b
	testb	$1, %r8b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	movslq	%esi, %r9
	movb	4182(%rax,%r9), %r8b
	movb	_m+4230(%rip), %r10b
	testb	$1, %r10b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	movslq	%esi, %r9
	movb	%r8b, 4186(%rax,%r9)
	movb	_m+4230(%rip), %r8b
	testb	$1, %r8b
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	movslq	%esi, %r9
	movzbl	4186(%rax,%r9), %esi
	andl	$15, %esi
	movb	%sil, %r8b
	movb	_m+4230(%rip), %r10b
	testb	$1, %r10b
...
LBB0_32:                                ##   in Loop: Header=BB0_28 Depth=1
	...
	cmovnel	%edx, %edi
	movslq	%edi, %r8
	movb	4186(%rax,%r8), %sil
	movl	_m+4202(%rip), %edi
	movl	%edi, %r8d
	movq	%rax, %r9
	addq	%r8, %r9
	movzwl	_m+4216(%rip), %edi
	movl	%edi, %r8d
	movl	21394(%rax,%r8,4), %edi
	movl	%edi, %r8d
	movb	%sil, (%r9,%r8)
	movl	_m+4202(%rip), %edi
	addl	$1, %edi
	movl	%edi, _m+4202(%rip)
	cmpl	$0, _m+4202(%rip)
	sete	%sil
	andb	$1, %sil
	movb	%sil, _m+4227(%rip)
	...
	cmovnel	%edx, %edi
	movslq	%edi, %r8
	movb	%sil, 4190(%rax,%r8)
	movb	_m+4230(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r8
	movzbl	4190(%rax,%r8), %ecx
	cmpl	$0, %ecx
	sete	%sil
	andb	$1, %sil
	movb	%sil, _m+4227(%rip)
...
LBB1_44:
	...
	movl	_m+21390(%rip), %eax
	movl	%eax, _m+4182(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+21390(%rip), %eax
	movl	%eax, _m+21390(%rip)
	movl	_m+4182(%rip), %esi
	movb	$0, %al
	callq	_printf
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21390(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280214, 21394(%rax,%rdx,4) ## imm = 0x414F96
	movl	_m+21390(%rip), %ecx
	movl	%ecx, _m+4182(%rip)
	movl	_m+4182(%rip), %esi
	movb	$0, %al
...
LBB1_51:
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzwl	4194(%rax,%r9), %r8d
	andl	$65535, %r8d            ## imm = 0xFFFF
	movb	_m+4230(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movzwl	4190(%rax,%r9), %ecx
	shll	$16, %ecx
	addl	%ecx, %r8d
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	%r8d, 21394(%rax,%r9,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	21394(%rax,%r9,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB1_55:
	...
	movl	_m+21906(%rip), %eax
	movl	%eax, %ecx
	addq	$21910, %rcx            ## imm = 0x5596
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21906(%rip), %eax
	movl	%eax, _m+21906(%rip)
	movl	_m+21906(%rip), %eax
	movl	%eax, %ecx
	addq	$21910, %rcx            ## imm = 0x5596
	movl	%ecx, %eax
...
Ltmp11:
	...
	leaq	_m(%rip), %rdx
	addq	$4280214, %rdx          ## imm = 0x414F96
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.25(%rip), %rdi
	movzbl	_m+4280214(%rip), %esi
