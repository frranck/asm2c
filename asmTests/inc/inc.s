...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$4926, %rdi             ## imm = 0x133E
	movb	$0, _m+4151(%rip)
	movslq	_m+4922(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+4922(%rip)
	movq	%rax, %r8
	movslq	_m+4922(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
## BB#28:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+4922(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+4922(%rip)
...
LBB2_44:
	...
	movl	_m+21310(%rip), %eax
	movl	%eax, _m+4103(%rip)
	movzwl	-1020(%rbp), %eax
	addl	_m+21310(%rip), %eax
	movl	%eax, _m+21310(%rip)
...
LBB2_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21310(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280134, 21314(%rax,%rdx,4) ## imm = 0x414F46
	movl	_m+21310(%rip), %ecx
	movl	%ecx, _m+4103(%rip)
	movl	_m+4103(%rip), %esi
	movb	$0, %al
...
LBB2_51:
	...
	cmovnel	%esi, %edx
	movslq	%edx, %r8
	movzwl	4111(%rcx,%r8), %edx
	shll	$16, %edx
	movl	-1276(%rbp), %esi       ## 4-byte Reload
	addl	%edx, %esi
	movzwl	-1018(%rbp), %edx
	movl	%edx, %r8d
	movl	%esi, 21314(%rcx,%r8,4)
	movzwl	-1018(%rbp), %esi
	movzwl	-1018(%rbp), %edx
	movl	%edx, %r8d
	movl	21314(%rcx,%r8,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB2_55:
	...
	movl	_m+21826(%rip), %eax
	movl	%eax, %ecx
	addq	$21830, %rcx            ## imm = 0x5546
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21826(%rip), %eax
	movl	%eax, _m+21826(%rip)
	movl	_m+21826(%rip), %eax
	movl	%eax, %ecx
	addq	$21830, %rcx            ## imm = 0x5546
	movl	%ecx, %eax
...
Ltmp11:
	...
	leaq	_m(%rip), %rdx
	addq	$4280134, %rdx          ## imm = 0x414F46
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.22(%rip), %rdi
	movzbl	_m+4280134(%rip), %esi
