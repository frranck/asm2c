...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$4935, %rdi             ## imm = 0x1347
	movb	$0, _m+4160(%rip)
	movslq	_m+4931(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+4931(%rip)
	movq	%rax, %r8
	movslq	_m+4931(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
	...
	callq	_longjmp
LBB0_4:
	movl	$-1430532899, _m+4116(%rip) ## imm = 0xFFFFFFFFAABBCCDD
...
## BB#7:
	jmp	LBB0_63
LBB0_8:
	movl	$65795, _m+4112(%rip)   ## imm = 0x10103
	callq	_is_little_endian
	leaq	_m(%rip), %rcx
	movl	$3, %edx
	xorl	%esi, %esi
	...
	movslq	%edx, %r8
	movb	4112(%rcx,%r8), %al
	movzwl	_m+4146(%rip), %edx
	movl	%edx, %r8d
	movl	21323(%rcx,%r8,4), %edx
	movl	%edx, %r8d
	movb	%al, (%rcx,%r8)
	movzwl	_m+4146(%rip), %edx
	movl	%edx, %r8d
...
LBB0_14:
	...
	movzwl	_m+4146(%rip), %edx
	movl	%edx, %esi
	movl	21323(%rax,%rsi,4), %edx
	movl	%edx, %esi
	movl	%ecx, 3(%rax,%rsi)
	movzwl	_m+4146(%rip), %ecx
	movl	%ecx, %esi
	movl	21323(%rax,%rsi,4), %ecx
	movl	%ecx, %esi
	movl	3(%rax,%rsi), %ecx
	subl	$65795, %ecx            ## imm = 0x10103
	cmpl	$0, %ecx
	sete	%dil
	andb	$1, %dil
	movb	%dil, _m+4157(%rip)
	movzwl	_m+4146(%rip), %ecx
	movl	%ecx, %esi
	movl	21323(%rax,%rsi,4), %ecx
	movl	%ecx, %esi
	cmpl	$65795, 3(%rax,%rsi)    ## imm = 0x10103
	setb	%dil
	andb	$1, %dil
	movb	%dil, _m+4156(%rip)
	movzwl	_m+4146(%rip), %ecx
	movl	%ecx, %esi
	movl	21323(%rax,%rsi,4), %ecx
	movl	%ecx, %esi
...
LBB0_22:
	...
	xorl	_m+4116(%rip), %ecx
	movl	%ecx, _m+4116(%rip)
	cmpl	$0, _m+4116(%rip)
	sete	%dl
	andb	$1, %dl
	movb	%dl, _m+4157(%rip)
	...
	cmovnel	%r8d, %ecx
	movslq	%ecx, %r10
	movw	-202(%rbp), %di         ## 2-byte Reload
	movw	%di, 4116(%rsi,%r10)
	callq	_is_little_endian
	leaq	_m(%rip), %rsi
	movl	$2, %ecx
	xorl	%r8d, %r8d
	...
	cmovnel	%r8d, %ecx
	movslq	%ecx, %r10
	movzwl	4116(%rsi,%r10), %ecx
	subl	$1284, %ecx             ## imm = 0x504
	cmpl	$0, %ecx
	sete	%al
	andb	$1, %al
	movb	%al, _m+4157(%rip)
...
LBB0_26:
	...
	cmovnel	%esi, %edx
	movslq	%edx, %r8
	movzwl	4116(%rcx,%r8), %edx
	movl	%edx, _m+4120(%rip)
	movl	_m+4120(%rip), %edx
	subl	$5, %edx
	cmpl	$0, %edx
	sete	%al
	andb	$1, %al
...
## BB#27:
	jmp	LBB0_63
LBB0_28:
	movl	_m+4120(%rip), %eax
	xorl	_m+4120(%rip), %eax
	movl	%eax, _m+4120(%rip)
	cmpl	$0, _m+4120(%rip)
	sete	%cl
	andb	$1, %cl
	movb	%cl, _m+4157(%rip)
...
## BB#29:
	...
	cmovnel	%esi, %edx
	movslq	%edx, %r8
	movzwl	4120(%rcx,%r8), %edx
	orl	$4294901760, %edx       ## imm = 0xFFFF0000
	movl	%edx, _m+4120(%rip)
	jmp	LBB0_31
LBB0_30:
	callq	_is_little_endian
...
LBB0_33:
	...
	xorl	_m+4116(%rip), %eax
	movl	%eax, _m+4116(%rip)
	cmpl	$0, _m+4116(%rip)
	sete	%cl
	andb	$1, %cl
	movb	%cl, _m+4157(%rip)
...
## BB#34:
	...
	cmovnel	%esi, %edx
	movslq	%edx, %r8
	movw	-206(%rbp), %r9w        ## 2-byte Reload
	movw	%r9w, 4116(%rcx,%r8)
	jmp	LBB0_36
LBB0_35:
	callq	_is_little_endian
	testb	%al, %al
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rsi
	movb	4116(%rdx,%rsi), %al
	movzbl	%al, %ecx
	movw	%cx, %di
	movw	%di, -208(%rbp)         ## 2-byte Spill
	callq	_is_little_endian
	leaq	_m(%rip), %rdx
	movl	$2, %ecx
	xorl	%r8d, %r8d
	...
	cmovnel	%r8d, %ecx
	movslq	%ecx, %rsi
	movw	-208(%rbp), %di         ## 2-byte Reload
	movw	%di, 4116(%rdx,%rsi)
LBB0_36:
	callq	_is_little_endian
	leaq	_m(%rip), %rcx
	movl	$2, %edx
...
## BB#39:
	...
	cmovnel	%esi, %edx
	movslq	%edx, %r8
	movw	-210(%rbp), %r9w        ## 2-byte Reload
	movw	%r9w, 4116(%rcx,%r8)
	jmp	LBB0_41
LBB0_40:
	callq	_is_little_endian
...
## BB#44:
	...
	movl	21323(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
	movzbl	14(%rax,%rdx), %ecx
	orl	$4294967040, %ecx       ## imm = 0xFFFFFF00
	movw	%cx, %si
	movw	%si, -214(%rbp)         ## 2-byte Spill
	callq	_is_little_endian
	leaq	_m(%rip), %rdx
	movl	$2, %ecx
	xorl	%edi, %edi
...
LBB0_45:
	...
	cmovnel	%r8d, %ecx
	movslq	%ecx, %r10
	movw	-216(%rbp), %di         ## 2-byte Reload
	movw	%di, 4116(%rdx,%r10)
LBB0_46:
	callq	_is_little_endian
	leaq	_m(%rip), %rcx
	movl	$2, %edx
...
## BB#49:
	...
	movl	21323(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
	movzbl	15(%rax,%rdx), %ecx
	orl	$4294967040, %ecx       ## imm = 0xFFFFFF00
	movw	%cx, %si
	movw	%si, -218(%rbp)         ## 2-byte Spill
	callq	_is_little_endian
	leaq	_m(%rip), %rdx
	movl	$2, %ecx
	xorl	%edi, %edi
...
## BB#54:
	...
	movl	21323(%rax,%rdx,4), %ecx
	movl	%ecx, %edx
	movzwl	15(%rax,%rdx), %ecx
	orl	$4294901760, %ecx       ## imm = 0xFFFF0000
	movw	%cx, %si
	movw	%si, -222(%rbp)         ## 2-byte Spill
	callq	_is_little_endian
	leaq	_m(%rip), %rdx
	movl	$2, %ecx
	xorl	%edi, %edi
...
LBB0_58:
	...
	movl	%ecx, _m+4116(%rip)
	movl	_m+4116(%rip), %ecx
	subl	$12345, %ecx            ## imm = 0x3039
	cmpl	$0, %ecx
	sete	%sil
	andb	$1, %sil
	movb	%sil, _m+4157(%rip)
	cmpl	$12345, _m+4116(%rip)   ## imm = 0x3039
	setb	%sil
	andb	$1, %sil
	movb	%sil, _m+4156(%rip)
	movl	_m+4116(%rip), %ecx
...
## BB#66:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+4931(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+4931(%rip)
...
LBB2_10:
	jmp	LBB2_61
LBB2_11:
	movl	$512, _m+4124(%rip)     ## imm = 0x200
	jmp	LBB2_61
LBB2_12:
	cmpq	$0, _m+4408143(%rip)
	je	LBB2_14
## BB#13:
	xorl	%esi, %esi
	...
	leaq	_m(%rip), %rdi
	leaq	-1008(%rbp), %r8
	movq	_m+4408143(%rip), %r9
	movl	_m+4124(%rip), %eax
	movl	%eax, %r10d
	movq	%rdi, %r11
	addq	%r10, %r11
	movzwl	_m+4146(%rip), %eax
	movl	%eax, %r10d
	movl	21323(%rdi,%r10,4), %eax
	movl	%eax, %edi
	addq	%rdi, %r11
	movq	%r8, %rdi
	movq	%r9, %r8
...
LBB2_44:
	...
	movl	_m+21319(%rip), %eax
	movl	%eax, _m+4112(%rip)
	movzwl	-1020(%rbp), %eax
	addl	_m+21319(%rip), %eax
	movl	%eax, _m+21319(%rip)
...
LBB2_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21319(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280143, 21323(%rax,%rdx,4) ## imm = 0x414F4F
	movl	_m+21319(%rip), %ecx
	movl	%ecx, _m+4112(%rip)
	movl	_m+4112(%rip), %esi
	movb	$0, %al
	...
	movl	_m+21319(%rip), %ecx
	addl	$1, %ecx
	movl	%ecx, _m+21319(%rip)
	movl	%eax, -1264(%rbp)       ## 4-byte Spill
	jmp	LBB2_61
LBB2_49:
	leaq	L_.str.58(%rip), %rdi
	movl	_m+4116(%rip), %esi
	movl	_m+4124(%rip), %edx
	movl	_m+4120(%rip), %ecx
	movb	$0, %al
	callq	_printf
	movzwl	-1018(%rbp), %ecx
	cmpl	_m+21319(%rip), %ecx
...
LBB2_55:
	...
	movl	_m+21835(%rip), %eax
	movl	%eax, %ecx
	addq	$21839, %rcx            ## imm = 0x554F
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21835(%rip), %eax
	movl	%eax, _m+21835(%rip)
	movl	_m+21835(%rip), %eax
	movl	%eax, %ecx
	addq	$21839, %rcx            ## imm = 0x554F
	movl	%ecx, %eax
	...
	movl	%esi, _m+4120(%rip)
	movl	-1080(%rbp), %esi
	shrl	$16, %esi
	movl	%esi, _m+4116(%rip)
	movl	$0, _m+4132(%rip)
	movl	$0, _m+4128(%rip)
	movl	-1080(%rbp), %esi
	movl	_m+4116(%rip), %edx
	movl	_m+4120(%rip), %ecx
...
Ltmp11:
	...
	movl	_m+4136(%rip), %esi
	movl	%eax, -40(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.11(%rip), %rdi
	leaq	_m(%rip), %rdx
	movzwl	_m+4144(%rip), %esi
	movzwl	_m+4144(%rip), %ecx
	movl	%ecx, %r8d
	movl	21323(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	movl	_m+4128(%rip), %esi
	movl	%eax, -52(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.14(%rip), %rdi
	leaq	_m(%rip), %rdx
	movl	_m+4128(%rip), %ecx
	movl	%ecx, %r8d
	movq	%rdx, %r9
	addq	%r8, %r9
	movzwl	_m+4146(%rip), %ecx
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4148(%rip), %esi
	movzwl	_m+4148(%rip), %ecx
	movl	%ecx, %r8d
	movl	21323(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	callq	_printf
	leaq	_m(%rip), %rdx
	addq	$4148, %rdx             ## imm = 0x1034
	movl	$4, %esi
	movq	%rdx, %rdi
	movl	%eax, -64(%rbp)         ## 4-byte Spill
	callq	_hexDump
	leaq	L_.str.16(%rip), %rdi
	movl	_m+4132(%rip), %esi
	movb	$0, %al
	callq	_printf
	leaq	L_.str.17(%rip), %rdi
	leaq	_m(%rip), %rdx
	movl	_m+4132(%rip), %ecx
	movl	%ecx, %r8d
	movq	%rdx, %r9
	addq	%r8, %r9
	movzwl	_m+4148(%rip), %ecx
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4150(%rip), %esi
	movzwl	_m+4150(%rip), %eax
	movl	%eax, %r8d
	movl	21323(%rdx,%r8,4), %eax
	movl	%eax, %r8d
	addq	%r8, %rdx
	movb	$0, %al
	callq	_printf
	...
	leaq	_m(%rip), %rdx
	movzwl	_m+4152(%rip), %esi
	movzwl	_m+4152(%rip), %ecx
	movl	%ecx, %r8d
	movl	21323(%rdx,%r8,4), %ecx
	movl	%ecx, %r8d
	addq	%r8, %rdx
	...
	leaq	_m(%rip), %rdx
	addq	$4280143, %rdx          ## imm = 0x414F4F
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.22(%rip), %rdi
	movzbl	_m+4280143(%rip), %esi
	movl	%eax, -88(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.23(%rip), %rdi
	movb	_m+4157(%rip), %r10b
	andb	$1, %r10b
	movzbl	%r10b, %esi
