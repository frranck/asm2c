...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$5452, %rdi             ## imm = 0x154C
	movb	$0, _m+49(%rip)
	movl	_m+5448(%rip), %ecx
	movl	%ecx, %r8d
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+5448(%rip)
	movq	%rax, %r8
	movl	_m+5448(%rip), %ecx
	movl	%ecx, %r9d
	shlq	$2, %r9
	...
	callq	_longjmp
LBB0_4:
	movl	$-1430532899, _m+4(%rip) ## imm = 0xFFFFFFFFAABBCCDD
	movzbl	_m+4(%rip), %eax
	subl	$221, %eax
	cmpl	$0, %eax
	sete	%cl
...
LBB0_8:
	leaq	_m(%rip), %rax
	movl	$65795, _m(%rip)        ## imm = 0x10103
	movb	_m(%rip), %cl
	movzwl	_m+34(%rip), %edx
	movl	%edx, %esi
	movl	4936(%rax,%rsi,4), %edx
	movl	%edx, %esi
	movb	%cl, 52(%rax,%rsi)
	movzwl	_m+34(%rip), %edx
	movl	%edx, %esi
...
LBB0_14:
	...
	movl	4936(%rax,%rsi,4), %ecx
	movl	%ecx, %esi
	cmpl	$65795, 55(%rax,%rsi)   ## imm = 0x10103
	setb	%dil
	andb	$1, %dil
	movb	%dil, _m+44(%rip)
	movzwl	_m+34(%rip), %ecx
...
## BB#29:
	movzwl	_m+8(%rip), %eax
	orl	$4294901760, %eax       ## imm = 0xFFFF0000
	movl	%eax, _m+8(%rip)
	jmp	LBB0_31
LBB0_30:
	movzwl	_m+8(%rip), %eax
...
## BB#34:
	movzbl	_m+4(%rip), %eax
	orl	$4294967040, %eax       ## imm = 0xFFFFFF00
	movw	%ax, %cx
	movw	%cx, _m+4(%rip)
	jmp	LBB0_36
LBB0_35:
...
LBB0_58:
	...
	andb	$1, %sil
	movb	%sil, _m+45(%rip)
	cmpl	$12345, _m+4(%rip)      ## imm = 0x3039
	setb	%sil
	andb	$1, %sil
	movb	%sil, _m+44(%rip)
	movl	_m+4(%rip), %ecx
...
## BB#66:
	...
	leaq	_m(%rip), %rdi
	addq	$5452, %rdi             ## imm = 0x154C
	movl	_m+5448(%rip), %eax
	movl	%eax, %r8d
	shlq	$2, %r8
	addq	%r8, %rdi
	callq	___memcpy_chk
	movl	_m+5448(%rip), %r9d
	movl	%r9d, %ecx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+5448(%rip)
	movl	_m+5448(%rip), %r9d
	movl	%r9d, %ecx
...
LBB1_44:
	...
	movl	_m+4932(%rip), %eax
	movl	%eax, _m(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+4932(%rip), %eax
	movl	%eax, _m+4932(%rip)
	movl	_m(%rip), %esi
	movb	$0, %al
	callq	_log_debug2
## BB#45:
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+4932(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280144, 4936(%rax,%rdx,4) ## imm = 0x414F50
	movl	_m+4932(%rip), %ecx
	movl	%ecx, _m(%rip)
	movl	_m(%rip), %esi
	movb	$0, %al
...
LBB1_51:
	...
	movzwl	-1022(%rbp), %edx
	movl	%edx, %esi
	movl	%ecx, 4936(%rax,%rsi,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r8d
	movl	4936(%rax,%r8,4), %edx
	movb	$0, %al
	callq	_log_debug2
	jmp	LBB1_61
LBB1_52:
...
L_.str.10:                              ## @.str.10
	.asciz	"xox %x (from beg RW) %x:g\n"

L_.str.11:                              ## @.str.11
	.asciz	"xox %x (from beg RW) %x:h\n"

L_.str.12:                              ## @.str.12
	.asciz	"xox %x (from beg RW) %x:h2\n"
