...
## BB#3:
	...
	movl	%ecx, %edx
	leaq	_m(%rip), %rdi
	addq	$4936, %rdi             ## imm = 0x1348
	movb	$0, _m+4161(%rip)
	movslq	_m+4932(%rip), %r8
	subq	$148, %r8
	movl	%r8d, %ecx
	movl	%ecx, _m+4932(%rip)
	movq	%rax, %r8
	movslq	_m+4932(%rip), %r9
	shlq	$2, %r9
	addq	%r9, %rdi
...
LBB0_4:
	...
	movb	_m+4160(%rip), %sil
	testb	$1, %sil
	movl	%ecx, %edi
	cmovnel	%edx, %edi
	movslq	%edi, %r8
	movzbl	4116(%rax,%r8), %edi
	subl	$221, %edi
	cmpl	$0, %edi
	sete	%sil
	andb	$1, %sil
...
LBB0_8:
	...
	cmovnel	%edx, %ecx
	movslq	%ecx, %rdi
	movb	4112(%rax,%rdi), %sil
	movzwl	_m+4146(%rip), %ecx
	movl	%ecx, %edi
	movl	21324(%rax,%rdi,4), %ecx
	movl	%ecx, %edi
	movb	%sil, (%rax,%rdi)
	movzwl	_m+4146(%rip), %ecx
	movl	%ecx, %edi
...
LBB0_14:
	...
	movl	%edx, %esi
	movl	21324(%rax,%rsi,4), %edx
	movl	%edx, %esi
	movl	%ecx, 3(%rax,%rsi)
	movzwl	_m+4146(%rip), %ecx
	movl	%ecx, %esi
	movl	21324(%rax,%rsi,4), %ecx
	movl	%ecx, %esi
	movl	3(%rax,%rsi), %ecx
...
LBB0_22:
	...
	movl	%esi, %r8d
	movl	21324(%rax,%r8,4), %esi
	movl	%esi, %r8d
	movw	7(%rax,%r8), %r9w
	movb	_m+4160(%rip), %dil
	testb	$1, %dil
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	movslq	%esi, %r8
	movw	%r9w, 4116(%rax,%r8)
	movb	_m+4160(%rip), %dil
	testb	$1, %dil
	movl	%ecx, %esi
	cmovnel	%edx, %esi
	movslq	%esi, %r8
	movzwl	4116(%rax,%r8), %esi
	subl	$1284, %esi             ## imm = 0x504
	cmpl	$0, %esi
	sete	%dil
	andb	$1, %dil
	movb	%dil, _m+4157(%rip)
...
## BB#34:
	...
	cmovnel	%edx, %esi
	movslq	%esi, %r8
	movzbl	4116(%rax,%r8), %esi
	orl	$4294967040, %esi       ## imm = 0xFFFFFF00
	movw	%si, %r9w
	movb	_m+4160(%rip), %dil
	testb	$1, %dil
	cmovnel	%edx, %ecx
...
LBB0_36:
	...
	cmovnel	%edx, %edi
	movslq	%edi, %r8
	movzwl	4116(%rax,%r8), %edi
	subl	$65535, %edi            ## imm = 0xFFFF
	cmpl	$0, %edi
	sete	%sil
	andb	$1, %sil
	movb	%sil, _m+4157(%rip)
...
## BB#44:
	...
	movzwl	_m+4146(%rip), %esi
	movl	%esi, %edi
	movl	21324(%rax,%rdi,4), %esi
	movl	%esi, %edi
	movzbl	14(%rax,%rdi), %esi
	orl	$4294967040, %esi       ## imm = 0xFFFFFF00
	movw	%si, %r8w
	movb	_m+4160(%rip), %r9b
	testb	$1, %r9b
	cmovnel	%edx, %ecx
	movslq	%ecx, %rdi
	movw	%r8w, 4116(%rax,%rdi)
	jmp	LBB0_46
LBB0_45:
	leaq	_m(%rip), %rax
	movl	$2, %ecx
	xorl	%edx, %edx
	leaq	_m(%rip), %rsi
	movzwl	_m+4146(%rip), %edi
	movl	%edi, %r8d
	movl	21324(%rsi,%r8,4), %edi
	movl	%edi, %r8d
	movb	14(%r8,%rsi), %r9b
	movzbl	%r9b, %edi
	movw	%di, %r10w
...
## BB#54:
	...
	movl	21324(%rax,%rdi,4), %esi
	movl	%esi, %edi
	movzwl	15(%rax,%rdi), %esi
	orl	$4294901760, %esi       ## imm = 0xFFFF0000
	movw	%si, %r8w
	movb	_m+4160(%rip), %r9b
	testb	$1, %r9b
	cmovnel	%edx, %ecx
...
## BB#66:
	...
	addq	%r8, %rdi
	callq	___memcpy_chk
	movslq	_m+4932(%rip), %rcx
	addq	$148, %rcx
	movl	%ecx, %r9d
	movl	%r9d, _m+4932(%rip)
...
LBB1_44:
	...
	movl	_m+21320(%rip), %eax
	movl	%eax, _m+4112(%rip)
	movzwl	-1024(%rbp), %eax
	addl	_m+21320(%rip), %eax
	movl	%eax, _m+21320(%rip)
...
LBB1_48:
	...
	leaq	_m(%rip), %rax
	movl	_m+21320(%rip), %ecx
	movl	%ecx, %edx
	movl	$4280144, 21324(%rax,%rdx,4) ## imm = 0x414F50
	movl	_m+21320(%rip), %ecx
	movl	%ecx, _m+4112(%rip)
	movl	_m+4112(%rip), %esi
	movb	$0, %al
...
LBB1_51:
	...
	cmovnel	%edx, %r8d
	movslq	%r8d, %r9
	movzwl	4124(%rax,%r9), %r8d
	andl	$65535, %r8d            ## imm = 0xFFFF
	movb	_m+4160(%rip), %sil
	testb	$1, %sil
	cmovnel	%edx, %ecx
	movslq	%ecx, %r9
	movzwl	4120(%rax,%r9), %ecx
	shll	$16, %ecx
	addl	%ecx, %r8d
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	%r8d, 21324(%rax,%r9,4)
	movzwl	-1022(%rbp), %esi
	movzwl	-1022(%rbp), %ecx
	movl	%ecx, %r9d
	movl	21324(%rax,%r9,4), %edx
	movb	$0, %al
	callq	_printf
...
LBB1_55:
	...
	movl	_m+21836(%rip), %eax
	movl	%eax, %ecx
	addq	$21840, %rcx            ## imm = 0x5550
	movl	%ecx, %eax
	movl	%eax, -1080(%rbp)
	movl	-1076(%rbp), %eax
	addl	_m+21836(%rip), %eax
	movl	%eax, _m+21836(%rip)
	movl	_m+21836(%rip), %eax
	movl	%eax, %ecx
	addq	$21840, %rcx            ## imm = 0x5550
	movl	%ecx, %eax
...
Ltmp11:
	...
	leaq	_m(%rip), %rdx
	addq	$4280144, %rdx          ## imm = 0x414F50
	movq	%rdx, %rsi
	movl	%eax, -84(%rbp)         ## 4-byte Spill
	movb	$0, %al
	callq	_printf
	leaq	L_.str.25(%rip), %rdi
	movzbl	_m+4280144(%rip), %esi
